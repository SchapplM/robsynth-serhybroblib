...
function tauc = fourbar1turnDE2_coriolisvecJ_fixb_slag_vp2(qJ, qJD, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(2,1),zeros(2,1),zeros(5,1),zeros(5,1),zeros(5,3),zeros(5,6)}
assert(isreal(qJ) && all(size(qJ) == [2 1]), ...
  'fourbar1turnDE2_coriolisvecJ_fixb_slag_vp2: qJ has to be [2x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [2 1]), ...
  'fourbar1turnDE2_coriolisvecJ_fixb_slag_vp2: qJD has to be [2x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'fourbar1turnDE2_coriolisvecJ_fixb_slag_vp2: pkin has to be [5x1] (double)');
assert(isreal(m) && all(size(m) == [5 1]), ...
  'fourbar1turnDE2_coriolisvecJ_fixb_slag_vp2: m has to be [5x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [5,3]), ...
  'fourbar1turnDE2_coriolisvecJ_fixb_slag_vp2: mrSges has to be [5x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [5 6]), ...
  'fourbar1turnDE2_coriolisvecJ_fixb_slag_vp2: Ifges has to be [5x6] (double)'); 

%% Symbolic Calculation
% From coriolisvec_joint_fixb_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-12 19:33:30
% EndTime: 2020-04-12 19:34:02
...
t284 = t116 * t124;
t330 = pkin(1) * t116;
t305 = -0.2e1 * ((0.4e1 * t216 + t275) * t335 + t184 * t352 + (-t148 / 0.2e1 + (t60 * t284 + (-t235 + (t124 * t64 + t125 * t92) * t116) * qJD(2)) * pkin(1)) * pkin(2)) * t349 - 0.2e1 * ((qJD(2) * t198 + t202 * t350 + t96 * t290) * t334 + qJD(2) * t179 + ((t243 / 0.2e1 - t61 * t330) * t124 + ((t278 + (-t114 + t297) * t124) * t334 + (-t124 * t66 - t125 * t93) * t330) * qJD(2)) * pkin(2)) * t195;
...
t31 = ((qJD(2) * t197 + t120 * t188 - t96 * t289) * t115 + t94 * t175 + ((t262 * t62 + t243) * t124 + ((t278 + (-t113 + t297) * t124) * t115 + (-t124 * t65 - t294) * t229) * qJD(2)) * pkin(1)) * t196;
t295 = t125 * t91;
t329 = pkin(1) * t132;
t63 = t108 + (-t278 + (t261 - t297) * t124) * pkin(1);
t320 = (((0.4e1 * t215 + t274) * t115 + t91 * t175) * t132 + (t148 + (-0.2e1 * t59 * t284 + (t286 * t342 + (-t124 * t63 - t295) * t254) * qJD(2)) * pkin(2)) * t329) * t94;
t78 = 0.1e1 / t80 ^ 2;
...
t159 = 0.2e1 * t180;
t156 = t70 * (-t296 / 0.2e1 + t295 / 0.2e1);
t155 = t192 * t242;
t154 = t191 * t242;
t153 = t190 * t242;
t95 = t151 * t127;
...
t9 = (qJD(2) * t150 + ((t293 / 0.2e1 + t294 / 0.2e1) * t317 + (qJD(2) * t187 - t124 * t59 - t62 * t125) * t69) * t115) * t132;
t10 = (qJD(2) * t149 + (t39 * t156 + (qJD(2) * t186 + t62 * t124 - t59 * t125) * t69) * t115) * t132;
t122 = Ifges(3,4) * t270;
...
t24 = (qJD(2) * t172 + t170 * t115) * t269;
t23 = (t94 * t168 + (t237 * t39 - t62 * t69) * t245) * t132;
t22 = (qJD(2) * t173 - t171 * t115) * t269;
...
t5 = -0.2e1 * ((t127 * t198 + t202 * t97 + t95 * t290) * t334 + t127 * t179 + ((t124 * t167 + t233) * t334 + (-0.2e1 * t266 * t61 - t279 * t93) * t330) * pkin(2)) * t195 - 0.2e1 * ((t117 * t136 * t352 + pkin(1) * t343) * t123 * t277 + ((t124 * t152 - t125 * t167) * t335 + (-t127 * t235 + (0.2e1 * t266 * t60 + t279 * t92) * t116) * pkin(1)) * pkin(2)) * t349 + 0.2e1 * (-t50 * t61 + t52 * t60) * t221 - 0.4e1 * pkin(4) * t220 * t163 + 0.2e1 * (t52 * t251 + (t42 * t76 * t87 + t60 * t75 * t88) * t50 * t93) * t260;
t1 = (-t163 * t212 + ((t258 * t64 + 0.4e1 * t310 * t44) * t52 + (t44 * t230 + (t256 * t64 + t346 * t66) * t75) * t50) * t118) * pkin(4) + t305;
t18 = [-(mrSges(4,2) * t351 - mrSges(4,3) * t21 + Ifges(4,1) * t7 + Ifges(4,4) * t8 + Ifges(4,5) * t6) * t48 - pkin(2) * (-mrSges(4,1) * t10 + mrSges(4,2) * t9) * t270 + (Ifges(3,1) * t125 - t301) * t228 + t22 * t154 / 0.2e1 - (-mrSges(4,1) * t8 + mrSges(4,2) * t7) * t325 + (-((-t92 * mrSges(5,1) - t93 * mrSges(5,2)) * t159 + (mrSges(5,1) * t171 + mrSges(5,2) * t170) * t115) * t269 + mrSges(5,1) * t22 - mrSges(5,2) * t24) * pkin(1) + (qJD(1) * (t124 * Ifges(3,1) + t300) + t110) * t265 / 0.2e1 - (t165 + t109) * t266 / 0.2e1 + t127 * (Ifges(3,5) * t125 - Ifges(3,6) * t124) / 0.2e1 + t37 * t244 + (t60 * t207 + t347 * t92) * t19 + (t61 * t206 - t347 * t93) * t20 + t24 * t155 / 0.2e1 + t5 * t153 / 0.2e1 + (-0.2e1 * m(4) * t281 - Ifges(3,2) * t124 + t300) * t125 * t263 + t10 * t14 / 0.2e1 + t9 * t15 / 0.2e1 + t93 * (Ifges(5,1) * t24 + Ifges(5,4) * t22 + Ifges(5,5) * t5) * t206 + t92 * (Ifges(5,4) * t24 + Ifges(5,2) * t22 + Ifges(5,6) * t5) * t207 + t33 * (Ifges(4,5) * t9 + Ifges(4,6) * t10) / 0.2e1 - t46 * (Ifges(4,1) * t9 + Ifges(4,4) * t10) / 0.2e1 + t47 * (Ifges(4,4) * t9 + Ifges(4,2) * t10) / 0.2e1 + ((-t10 * t94 + t9 * t91) * mrSges(4,3) * t299 + (-mrSges(4,1) * t351 + mrSges(4,3) * t23 + Ifges(4,4) * t7 + Ifges(4,2) * t8 + Ifges(4,6) * t6) * t187) * t241 + (-t34 * (-t190 * t159 + (Ifges(5,5) * t170 - Ifges(5,6) * t171) * t115) / 0.2e1 + (t93 * (-t192 * t159 + (Ifges(5,1) * t170 - Ifges(5,4) * t171) * t115) / 0.2e1 - t92 * (-t191 * t159 + (Ifges(5,4) * t170 - Ifges(5,2) * t171) * t115) / 0.2e1) * t115 * t67 * t269) * t129; -t318 * t341 - t2 * t13 / 0.2e1 - t12 * t14 / 0.2e1 - t11 * t15 / 0.2e1 - t25 * t16 - t26 * t19 / 0.2e1 - t27 * t17 - t28 * t20 / 0.2e1 - t33 * (Ifges(4,5) * t11 + Ifges(4,6) * t12 + Ifges(4,3) * t2) / 0.2e1 + t34 * (Ifges(5,5) * t28 + Ifges(5,6) * t26 + Ifges(5,3) * t1) / 0.2e1 + t46 * (Ifges(4,1) * t11 + Ifges(4,4) * t12 + Ifges(4,5) * t2) / 0.2e1 - t47 * (Ifges(4,4) * t11 + Ifges(4,2) * t12 + Ifges(4,6) * t2) / 0.2e1 + (-t1 / 0.2e1 + t341) * (qJD(1) * t153 - t318) + (t319 / 0.2e1 - t315 / 0.2e1 + t314 / 0.2e1 + t13 / 0.2e1) * t4 + m(4) * (-t71 * t158 * t277 + (t71 * t164 - t304 / t74 ^ 2 * t39) * t135 * t267) * t133 / 0.2e1 + ((t321 / 0.2e1 + t322 / 0.2e1) * t317 + (-t59 * t16 - t62 * t17 + (-m(4) * t23 + mrSges(4,2) * t6 - mrSges(4,3) * t8 + (m(4) * t27 - mrSges(4,2) * t336 + mrSges(4,3) * t12) * qJD(2)) * t94 + (-m(4) * t21 - mrSges(4,1) * t6 + mrSges(4,3) * t7 + (m(4) * t25 + mrSges(4,1) * t336 - mrSges(4,3) * t11) * qJD(2)) * t91) * t69) * t328 * t132 + (mrSges(4,1) * t21 - mrSges(4,2) * t23 + Ifges(4,5) * t7 + Ifges(4,6) * t8 + Ifges(4,3) * t6) * (-t160 * t324 + 0.1e1) + (pkin(1) * (-mrSges(5,1) * t26 + mrSges(5,2) * t28) + (t292 / 0.2e1 - t110 / 0.2e1 - t122 / 0.2e1 + pkin(2) * (-mrSges(4,1) * t12 + mrSges(4,2) * t11)) * t125 + ((Ifges(5,1) * t28 + Ifges(5,4) * t26 + Ifges(5,5) * t1) * t339 + t92 * (Ifges(5,4) * t28 + Ifges(5,2) * t26 + Ifges(5,6) * t1) / 0.2e1 + (t333 / 0.2e1 - t332 / 0.2e1) * t3) * t242 + (-t291 / 0.2e1 + t109 / 0.2e1 - pkin(2) * t37 + Ifges(3,4) * t271 / 0.2e1 + (m(4) * t135 - Ifges(3,1) / 0.2e1 + Ifges(3,2) / 0.2e1) * t270) * t124) * qJD(1) + (Ifges(5,5) * t24 + Ifges(5,6) * t22 + Ifges(5,3) * t5) * t162 * t260 + (t321 + t322) * t264 * t181;];
tauc = t18(:);
