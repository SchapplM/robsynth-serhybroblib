...
function T = fourbar1turnDE2_energykin_floatb_twist_slag_vp2(qJ, qJD, V_base, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(2,1),zeros(2,1),zeros(6,1),zeros(5,1),zeros(5,1),zeros(5,3),zeros(5,6)}
assert(isreal(qJ) && all(size(qJ) == [2 1]), ...
  'fourbar1turnDE2_energykin_floatb_twist_slag_vp2: qJ has to be [2x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [2 1]), ...
  'fourbar1turnDE2_energykin_floatb_twist_slag_vp2: qJD has to be [2x1] (double)');
assert(isreal(V_base) && all(size(V_base) == [6 1]), ...
  'fourbar1turnDE2_energykin_floatb_twist_slag_vp2: V_base has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'fourbar1turnDE2_energykin_floatb_twist_slag_vp2: pkin has to be [5x1] (double)');
assert(isreal(m) && all(size(m) == [5 1]), ...
  'fourbar1turnDE2_energykin_floatb_twist_slag_vp2: m has to be [5x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [5,3]), ...
  'fourbar1turnDE2_energykin_floatb_twist_slag_vp2: mrSges has to be [5x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [5 6]), ...
  'fourbar1turnDE2_energykin_floatb_twist_slag_vp2: Ifges has to be [5x6] (double)'); 
...
t2 = -t40 - 0.2e1 * ((t51 * t74 + (t68 * pkin(1) * t85 + ((t43 * t59 + t83) * t45 / 0.2e1 - t21 * t46 * t87) * pkin(2)) * qJD(2)) / t20 + (t57 * t74 + (-(-t82 + t84) * t45 / 0.2e1 + (t20 * t46 - t45 * t51) * t87) * qJD(2)) * pkin(2) * t21 * t16) * pkin(4) / (t16 * t17 + 0.1e1) * t47 * t63;
t1 = t39 + ((-t52 * t76 + (0.2e1 * t69 * pkin(2) * t85 + ((t42 * t59 + t83) * t45 + t22 * t57 * t79) * pkin(1)) * qJD(2)) / t19 - (-t57 * t76 + (-t45 * t82 + ((t52 * t91 + t42) * t45 + t19 * t79) * t57) * qJD(2)) * pkin(1) * t22 * t15) * pkin(3) / (t15 * t18 + 0.1e1) * t47 * t66;
