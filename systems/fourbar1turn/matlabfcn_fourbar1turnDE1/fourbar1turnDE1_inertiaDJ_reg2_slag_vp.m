...
function MMD_reg = fourbar1turnDE1_inertiaDJ_reg2_slag_vp(qJ, qJD, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(2,1),zeros(2,1),zeros(5,1)}
assert(isreal(qJ) && all(size(qJ) == [2 1]), ...
  'fourbar1turnDE1_inertiaDJ_reg2_slag_vp: qJ has to be [2x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [2 1]), ...
  'fourbar1turnDE1_inertiaDJ_reg2_slag_vp: qJD has to be [2x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [5 1]), ...
  'fourbar1turnDE1_inertiaDJ_reg2_slag_vp: pkin has to be [5x1] (double)');

%% Symbolic Calculation
% From inertiaD_joint_joint_fixb_regressor_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-12 19:27:15
% EndTime: 2020-04-12 19:27:29
...
t204 = pkin(2) * t76;
t71 = t85 * t204;
t28 = t71 + (-t172 + (t161 - t183) * t85) * pkin(2);
t173 = t85 * t99;
...
t153 = t95 * t84 * pkin(1);
t182 = t67 * t81;
t30 = t63 * t182 + 0.2e1 * t153 + (t76 * t86 + t173) * pkin(2);
...
t201 = pkin(3) * t80;
t200 = pkin(4) * t80;
t135 = 0.4e1 / t180 * t62 * t183;
t120 = -t135 / 0.4e1;
t61 = (t86 * t130 - 0.4e1 * t95 * t177) * qJD(2);
t108 = (-0.2e1 * t86 * t184 + (-t67 * t61 + t120) * t85) * t77;
t121 = t79 * t95 * t146;
t162 = 0.2e1 * t200;
t125 = t16 * t59 * t162;
t144 = t85 * t164;
...
t179 = t77 * t86;
t25 = t62 * t182 + 0.2e1 * t132 + t169;
t190 = t25 * t78;
t24 = (-t148 + (-t172 + (t76 + t161) * t85) * qJD(2)) * pkin(2);
t192 = t24 * t52 / t51;
t1 = 0.2e1 * (t125 * t53 + t162 * t194) / t45 ^ 2 * (t25 * t188 - t55 * t192) + 0.2e1 * (pkin(4) * t136 * t223 + t125 * t192) * t41 + 0.2e1 * ((-t16 * t25 + t18 * t24) * t53 + (-((t81 * t135 / 0.4e1 + t61 * t182 + 0.6e1 * pkin(1) * t129) * t209 + 0.4e1 * t59 * t121 + ((t149 / 0.2e1 - pkin(1) * t190) * t85 + ((t172 + (-t76 + t183) * t85) * t209 + (-t30 * t85 - t86 * t59) * t78 * pkin(1)) * qJD(2)) * pkin(2)) * t52 - ((0.4e1 * t132 + t169) * t210 - 0.4e1 * t58 * t121 + (-t108 / 0.2e1 + (t24 * t178 + (-t81 * t179 + (t28 * t85 + t58 * t86) * t78) * qJD(2)) * pkin(1)) * pkin(2)) * t188) * t89) * t156;
t199 = t1 * t77;
t191 = t24 * t58;
...
t140 = t43 * t157;
t128 = -0.2e1 * t142;
t27 = t72 + (-t172 + (t163 - t183) * t85) * pkin(1);
t17 = (t57 * t128 + t27 * t77) * t92;
t29 = -t63 * t181 + t177 * t214 + (t75 * t86 + t173) * pkin(1);
