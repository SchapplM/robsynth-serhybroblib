...
function jv = hybBKspatial_kinconstr_expl_mdh_sym_varpar(qJ, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(6,1),zeros(7,1)}
assert(isreal(qJ) && all(size(qJ) == [6 1]), ...
  'hybBKspatial_kinconstr_expl_mdh_sym_varpar: qJ has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [7 1]), ...
  'hybBKspatial_kinconstr_expl_mdh_sym_varpar: pkin has to be [7x1] (double)');

%% Symbolic Calculation
% From kinconstr_expl_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-11 19:19:27
% EndTime: 2020-04-11 19:19:30
...
t239 = t72 + t82;
t160 = -(t108 + ((5 * t127) + t38) * t255 + t50 * (t82 + t182)) * t250 + (t138 + (t225 + t239) * t131 + t103 + 0.2e1 * t230 + t133 * (t133 + t239)) * t48;
t186 = t133 + t260;
t162 = t127 + t186;
t68 = -t119 / 0.6e1;
t240 = t68 - t122 / 0.6e1;
...
t3 = [qJ(1); qJ(2); atan2(t1 * t20 + t2 * t21, t1 * t21 - t2 * t20); qJ(3); atan2(t6 * t181, t5 * t181); qJ(4); qJ(5); qJ(6); atan2(t7 * t173, t173 * t254); 0;];
jv = t3(:);
