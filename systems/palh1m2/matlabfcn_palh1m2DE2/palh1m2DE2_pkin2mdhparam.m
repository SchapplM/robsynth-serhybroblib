...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = palh1m2DE2_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(22,1)}
assert(isreal(pkin) && all(size(pkin) == [22 1]), ...
  'palh1m2DE2_pkin2mdhparam: Kinematic parameters pkin have to be [22x1] (double)');
