...
function Ja_rot = palh1m2TE_jacobia_rot_sym_varpar(qJ, link_index, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),uint8(0),zeros(22,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh1m2TE_jacobia_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh1m2TE_jacobia_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [22 1]), ...
  'palh1m2TE_jacobia_rot_sym_varpar: pkin has to be [22x1] (double)');
Ja_rot=NaN(3,4);
if link_index == 0
...
elseif link_index == 5
	...
	t52 = t54 ^ 2;
	t46 = 0.1e1 / (0.1e1 + t63 ^ 2 * t52 / t53 ^ 2);
	t72 = t46 / t53;
	t62 = sin(qJ(4));
	t65 = cos(qJ(4));
	t69 = t53 * t66;
	...
	t68 = t53 * t63;
	t42 = 0.1e1 / t70;
	t1 = [-t66 * t54 * t72, 0, 0, 0; (-0.1e1 / t41 * t71 - (t44 * t52 * t63 * t72 + (t46 - 0.1e1) * t54 * t43) * t54 * t73) / (t52 * t73 + 0.1e1), 0, 0, 0; ((t62 * t68 - t66 * t65) / t50 + (t66 * t62 + t65 * t68) * t48 * t47) * t42, 0, 0, t70 * t42;];
	Ja_rot = t1;
elseif link_index == 6
	%% Symbolic Calculation
