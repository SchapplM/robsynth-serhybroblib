...
function Jg_rot = palh1m2TE_jacobig_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),uint8(0),zeros(22,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh1m2TE_jacobig_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh1m2TE_jacobig_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [22 1]), ...
  'palh1m2TE_jacobig_rot_sym_varpar: pkin has to be [22x1] (double)');
Jg_rot=NaN(3,4);
if link_index == 0
...
elseif link_index == 5
	...
	t75 = -t83 * t80 + t82 * t81;
	t74 = -t75 * t78 + t77 * t76;
	t1 = [0, 0, 0, cos(qJ(1)) * t74; 0, 0, 0, sin(qJ(1)) * t74; 1, 0, 0, t75 * t77 + t78 * t76;];
	Jg_rot = t1;
elseif link_index == 6
	%% Symbolic Calculation
