...
function JR_rot = palh1m2DE1_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),uint8(0),zeros(22,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh1m2DE1_jacobiR_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh1m2DE1_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [22 1]), ...
  'palh1m2DE1_jacobiR_rot_sym_varpar: pkin has to be [22x1] (double)');
JR_rot=NaN(9,4);
if link_index == 0
...
elseif link_index == 4
	...
	t28 = -t29 * t32 + t31 * t30;
	t27 = t29 * t31 + t32 * t30;
	t1 = [t27 * t36, 0, 0, 0; -t27 * t38, 0, 0, 0; 0, 0, 0, 0; t28 * t36, 0, 0, 0; -t28 * t38, 0, 0, 0; 0, 0, 0, 0; t38, 0, 0, 0; t36, 0, 0, 0; 0, 0, 0, 0;];
	JR_rot = t1;
elseif link_index == 5
	%% Symbolic Calculation
	...
	t1 = [t85, 0, 0, t86; -t87, 0, 0, t84; 0, 0, 0, -t88 * t96; -t84, 0, 0, t87; t86, 0, 0, t85; 0, 0, 0, -t88 * t99; -t88 * t97, 0, 0, 0; t88 * t100, 0, 0, 0; 0, 0, 0, 0;];
	JR_rot = t1;
elseif link_index == 6
	%% Symbolic Calculation
...
elseif link_index == 8
	...
	t51 = t61 * t56 + t58 * t57;
	t53 = t58 * t56 - t61 * t57;
	t64 = (t59 * t51 + t62 * t53) * t60;
	t1 = [t43 * t60, -t72, -t72, 0; -t73, -t71, -t71, 0; 0, -t43, -t43, 0; t71, t73, t73, 0; (-t51 * t62 + t59 * t53) * t63, t64, t64, 0; 0, -t67, -t67, 0; t63, 0, 0, 0; t60, 0, 0, 0; 0, 0, 0, 0;];
	JR_rot = t1;
elseif link_index == 9
	%% Symbolic Calculation
