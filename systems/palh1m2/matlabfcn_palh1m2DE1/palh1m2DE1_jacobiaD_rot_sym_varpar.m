...
function JaD_rot = palh1m2DE1_jacobiaD_rot_sym_varpar(qJ, qJD, link_index, ...
  pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(4,1),uint8(0),zeros(22,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh1m2DE1_jacobiaD_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'palh1m2DE1_jacobiaD_rot_sym_varpar: qJD has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh1m2DE1_jacobiaD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [22 1]), ...
  'palh1m2DE1_jacobiaD_rot_sym_varpar: pkin has to be [22x1] (double)');
JaD_rot=NaN(3,4);
if link_index == 0
...
elseif link_index == 5
	...
	t147 = t149 ^ 2;
	t155 = t160 ^ 2;
	t133 = t147 * t155 * t144 + 0.1e1;
	t131 = 0.1e1 / t133;
	t196 = (t131 - 0.1e1) * t149;
	t185 = t149 * t160;
	t130 = atan2(-t185, t148);
	t128 = sin(t130);
	t129 = cos(t130);
	t122 = -t128 * t185 + t129 * t148;
	t119 = 0.1e1 / t122;
	t135 = 0.1e1 / t198;
	t143 = 0.1e1 / t148;
	t120 = 0.1e1 / t122 ^ 2;
