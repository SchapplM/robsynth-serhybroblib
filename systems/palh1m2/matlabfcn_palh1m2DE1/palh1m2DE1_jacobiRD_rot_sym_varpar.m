...
function JRD_rot = palh1m2DE1_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(4,1),uint8(0),zeros(22,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh1m2DE1_jacobiRD_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'palh1m2DE1_jacobiRD_rot_sym_varpar: qJD has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh1m2DE1_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [22 1]), ...
  'palh1m2DE1_jacobiRD_rot_sym_varpar: pkin has to be [22x1] (double)');
JRD_rot=NaN(9,4);
if link_index == 0
...
elseif link_index == 8
	...
	t158 = t160 * qJD(3);
	t159 = t198 * qJD(3);
	t175 = (t181 * qJD(2) + t173 * t158 + t170 * t159) * t171 + t199 * t183;
	t1 = [t147 * t183 - t171 * t176, t195, t195, 0; t201, -t140, -t140, 0; 0, t176, t176, 0; t140, -t201, -t201, 0; (t199 * qJD(2) + t170 * t158 - t159 * t173) * t174 + t181 * t184, t175, t175, 0; 0, t177, t177, 0; -t184, 0, 0, 0; t183, 0, 0, 0; 0, 0, 0, 0;];
	JRD_rot = t1;
elseif link_index == 9
	%% Symbolic Calculation
