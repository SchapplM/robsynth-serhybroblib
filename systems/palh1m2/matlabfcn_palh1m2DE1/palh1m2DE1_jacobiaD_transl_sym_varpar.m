...
function JaD_transl = palh1m2DE1_jacobiaD_transl_sym_varpar(qJ, qJD, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh1m2DE1_jacobiaD_transl_sym_varpar: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'palh1m2DE1_jacobiaD_transl_sym_varpar: qJD has to be [4x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'palh1m2DE1_jacobiaD_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh1m2DE1_jacobiaD_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [22 1]), ...
  'palh1m2DE1_jacobiaD_transl_sym_varpar: pkin has to be [22x1] (double)');
JaD_transl=NaN(3,4);
if link_index == 0
...
elseif link_index == 5
	...
	% OptimizationMode: 2
	% StartTime: 2020-05-01 21:04:24
	% EndTime: 2020-05-01 21:04:24
...
elseif link_index == 8
	...
	t91 = t98 * qJD(2);
	t92 = t136 * qJD(2);
	t134 = t82 * qJD(3) + t91 * t104 - t92 * t107;
	t117 = t104 * t136 + t98 * t107;
	t113 = -qJD(3) * t117 - t104 * t92 - t91 * t107;
	t139 = r_i_i_C(1) * t113;
	t135 = t134 * r_i_i_C(2) + t139;
	t137 = -t104 * t102 + t107 * t103;
	t95 = t107 * t102 + t104 * t103;
	t138 = t105 * t95 - t108 * t137;
	t106 = sin(qJ(1));
	t115 = -t105 * t137 - t95 * t108;
	t109 = cos(qJ(1));
	t119 = qJD(1) * t109;
	t93 = t95 * qJD(3);
	t94 = t137 * qJD(3);
	t133 = ((-qJD(2) * t115 + t105 * t94 + t108 * t93) * t106 + t138 * t119) * r_i_i_C(2) + (t106 * t134 - t117 * t119) * r_i_i_C(1);
	t120 = qJD(1) * t106;
	t132 = (-t109 * t113 - t82 * t120) * r_i_i_C(2) + (t109 * t134 + t117 * t120) * r_i_i_C(1);
	t118 = t82 * r_i_i_C(1) - pkin(15);
	t1 = [-t135 * t106 + (-r_i_i_C(3) * t106 + (r_i_i_C(2) * t117 + t118) * t109) * qJD(1), t132, t132, 0; (t139 + (t138 * qJD(2) + t105 * t93 - t94 * t108) * r_i_i_C(2)) * t109 + (t109 * r_i_i_C(3) + (-r_i_i_C(2) * t115 + t118) * t106) * qJD(1), t133, t133, 0; 0, t135, t135, 0;];
	JaD_transl = t1;
elseif link_index == 9
	%% Symbolic Calculation
