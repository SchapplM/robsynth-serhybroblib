...
%   see fourbar2OL_invdynJ_fixb_regmin2vec.m
% MDP [9x1]
...
function tauJ = fourbar2OL_invdynJ_fixb_mdp_slag_vr(RV, MDP)
%% Coder Information
%#codegen
%$cgargs {zeros(12,1), zeros(9,1)}
assert(isreal(MDP) && all(size(MDP) == [9 1]), ...
  'fourbar2OL_invdynJ_fixb_mdp_slag_vr: MDP has to be [9x1] (double)'); 
