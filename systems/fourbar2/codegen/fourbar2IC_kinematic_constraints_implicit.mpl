...
# 
# fourbar2_OL -> Viergelenkkette, modellierung impliziten der Zwangsbedingungen mit Ausdrücken einer offenen Kette  und basierend auf der MDH-Tabelle. 
# Bei Matlab: Abhängige Winkel durch die Ausdrücke von TE aus der Datei "fourbar2TE_kinconstr_expl_mdh_sym_varpar" ersetzen.
# Quelle
# Autor
# 
# Initialisierung
