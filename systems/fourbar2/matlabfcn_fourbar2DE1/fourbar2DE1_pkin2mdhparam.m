...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = fourbar2DE1_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(2,1)}
assert(isreal(pkin) && all(size(pkin) == [2 1]), ...
  'fourbar2DE1_pkin2mdhparam: Kinematic parameters pkin have to be [2x1] (double)');
