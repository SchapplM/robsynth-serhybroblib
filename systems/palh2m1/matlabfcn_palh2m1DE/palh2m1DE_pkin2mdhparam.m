...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = palh2m1DE_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(6,1)}
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'palh2m1DE_pkin2mdhparam: Kinematic parameters pkin have to be [6x1] (double)');
