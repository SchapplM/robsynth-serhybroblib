...
function T = picker2Dm1DE1_energykin_floatb_twist_slag_vp2(qJ, qJD, V_base, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(2,1),zeros(2,1),zeros(6,1),zeros(9,1),zeros(11,1),zeros(11,3),zeros(11,6)}
assert(isreal(qJ) && all(size(qJ) == [2 1]), ...
  'picker2Dm1DE1_energykin_floatb_twist_slag_vp2: qJ has to be [2x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [2 1]), ...
  'picker2Dm1DE1_energykin_floatb_twist_slag_vp2: qJD has to be [2x1] (double)');
assert(isreal(V_base) && all(size(V_base) == [6 1]), ...
  'picker2Dm1DE1_energykin_floatb_twist_slag_vp2: V_base has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'picker2Dm1DE1_energykin_floatb_twist_slag_vp2: pkin has to be [9x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm1DE1_energykin_floatb_twist_slag_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'picker2Dm1DE1_energykin_floatb_twist_slag_vp2: mrSges has to be [11x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [11 6]), ...
  'picker2Dm1DE1_energykin_floatb_twist_slag_vp2: Ifges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From energy_kinetic_floatb_twist_linkframe_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-10 09:11:01
% EndTime: 2020-05-10 09:13:15
% DurationCPUTime: 87.58s
...
t159 = 0.4e1 * t576 + 0.6e1 * t226 * t624 + t287 * t630 + (t244 * t589 + t322 * t513) * pkin(1);
t395 = 6 * t425;
t495 = -0.4e1 * t508;
...
t214 = t297 + t305 + t495;
t633 = t374 * t375;
t231 = pkin(3) * t633 + t303 * t372;
t138 = -t214 * t646 + t231 * t429 + (t284 * t590 + t297 * t635) * pkin(3) + (-0.2e1 * t647 + (0.2e1 * t335 - 0.4e1) * t419 - t310) * pkin(1);
t648 = t248 * t430;
...
t649 = t242 * t339;
t682 = pkin(7) * t372;
t660 = ((0.8e1 * t492 - 0.4e1 * t649) * t425 + (t308 * t692 + t551) * t592 + (0.2e1 * t374 ^ 2 * t591 * t682 + (t219 * t596 - t375 * t542) * t303 + (t265 * t526 + (-t219 * t633 - t265 * t636) * qJD(2)) * pkin(3)) * t586) / t429;
t525 = t660 / 0.2e1;
t595 = qJD(1) * t374;
t632 = t375 * t429;
t634 = t372 * t429;
t111 = t231 * t525 + (-t295 * t375 + (t214 * t372 + t632) * qJD(1)) * t303 + (t481 + 0.4e1 * t492 - 0.2e1 * t649) * pkin(1) + ((t297 * t375 - t634) * t595 + (-t214 * t633 - t297 * t636 - t429 * t471) * qJD(2) + (t284 * t592 + t324 * t456) * t597 + t303 * t450) * pkin(3);
t240 = t248 * qJD(1);
t241 = t249 * qJD(1);
t516 = t240 * t709;
...
t678 = t140 / 0.4e1;
t679 = t138 / 0.4e1;
t110 = t227 * t525 + (t178 * t375 - t303 * t634) * qJD(1) + (t242 * t375 - t250 * t596) * t372 * t709 + ((-t632 + (-t262 - 0.8e1 * t568) * t372) * t595 + ((-t182 + t634) * t371 + (t632 + (t303 * t597 + t262) * t372 + (t339 * t709 - pkin(1) + t681) * t374 * t708) * t374) * qJD(2)) * pkin(3);
t680 = t110 / 0.4e1;
...
t573 = 0.8e1 * t625;
t588 = 0.6e1 * t681;
t144 = t321 * t573 + t243 * t512 + 0.14e2 * t170 * t624 + (t331 * t437) + (t315 - 0.10e2 / 0.3e1 * t423 + (2 * t427) - t623) * t419 + t239 * t630 + (t172 * t588 + t322 * t486) * pkin(1);
t400 = 8 * t428;
t220 = t432 * t514 + t340 + t688 + (t386 + t400) * t425;
t235 = -t425 + t475 + t702;
t160 = t517 + t220 * t339 + t292 * t332 + (t235 * t589 + t513 * t630) * pkin(1);
t600 = t427 - t423;
...
t197 = t285 * t631 + t292 * t329;
t276 = 16 * (t599 - 6 * t626) * t423;
...
t511 = 0.32e2 * t576;
t643 = t323 * (-t419 + t310);
t107 = t276 * t337 + t197 * t511 + 0.24e2 * t162 * t624 + (t386 + t402 + (28 * t425)) * t416 + t298 * t643 + (0.24e2 * t144 * t335 + t327 * t423 + t388 * t427 + t465 * t395 + t604 * t404 + (28 * t432 ^ 2) + 0.4e1 * t441 ^ 2) * t419 + (0.32e2 * t160 * t641 + t324 * t707) * t304 + 0.8e1 * (t158 * t681 - t166 * t566) * pkin(1) + (0.16e2 * t184 * t333 + t327 * t425 + (70 * t423) + t437 + t465) * t437;
...
t639 = t338 * t423;
t146 = -0.4e1 * t639 * t682 + t192 * t570 + (-0.8e1 / 0.3e1 * t625 + t198) * t325 + (t204 * t589 + t372 * t675) * pkin(1);
t608 = t386 + t713;
t534 = t401 + t608;
...
t561 = -0.12e2 * t640;
t572 = -0.6e1 * t624;
t116 = t206 * t512 + t167 * t506 + t146 * t561 + t164 * t572 + (-0.6e1 * t147 * t645 + (0.24e2 * t320 * t625 - t165) * t374) * pkin(3) + (-0.6e1 * t163 * t681 + (t175 + t503) * t372) * pkin(1);
...
t33 = cos(t35);
t32 = sin(t35);
t25 = (-t458 * t656 + (t111 * t673 + t138 * t660 / 0.8e1 + t140 * t498 + (t54 * t678 + t680 * t83) * t113) * t189) * t627;
t24 = (-t457 * t656 + (t138 * t498 + t110 * t674 - t140 * t660 / 0.8e1 + (t111 * t83 / 0.4e1 + t54 * t679) * t113) * t189) * t627;
...
t4 = pkin(6) * t5 + t13;
t3 = (-t695 * t669 / 0.4e1 + t693 * t664 / 0.2e1) / (0.1e1 - 0.1e1 / pkin(6) ^ 2 / t435 * t693 * t667 / 0.4e1) * t629 + t5;
t2 = -t14 * t59 - t4 * t58;
t1 = t14 * t58 - t4 * t59;
t7 = (t229 * mrSges(6,2) - t97 * mrSges(6,3) + Ifges(6,5) * t81 + Ifges(6,1) * t102 / 0.2e1) * t102 + (-t100 * mrSges(4,1) + t14 * mrSges(4,3) + Ifges(4,4) * t17 + Ifges(4,6) * t5 + Ifges(4,2) * t16 / 0.2e1) * t16 + (V_base(3) * mrSges(2,2) - t263 * mrSges(2,3) + Ifges(2,5) * t319 + Ifges(2,1) * t258 / 0.2e1) * t258 + (t100 * mrSges(4,2) - t13 * mrSges(4,3) + Ifges(4,5) * t5 + Ifges(4,1) * t17 / 0.2e1) * t17 + (-t229 * mrSges(6,1) + t98 * mrSges(6,3) + Ifges(6,4) * t102 + Ifges(6,6) * t81 + Ifges(6,2) * t101 / 0.2e1) * t101 + (t103 * mrSges(3,1) - t104 * mrSges(3,2) + Ifges(3,3) * t64 / 0.2e1) * t64 + m(2) * (t263 ^ 2 + t264 ^ 2 + t377) / 0.2e1 + m(1) * (V_base(1) ^ 2 + V_base(2) ^ 2 + t377) / 0.2e1 + (t97 * mrSges(6,1) - t98 * mrSges(6,2) + Ifges(6,3) * t81 / 0.2e1) * t81 + m(4) * (t100 ^ 2 + t13 ^ 2 + t14 ^ 2) / 0.2e1 + (-t301 * mrSges(8,1) + t237 * mrSges(8,3) + Ifges(8,6) * t318 + Ifges(8,2) * t257 / 0.2e1) * t257 + m(5) * (t36 ^ 2 + t37 ^ 2 + t99 ^ 2) / 0.2e1 + (V_base(2) * mrSges(1,1) - V_base(1) * mrSges(1,2) + Ifges(1,3) * V_base(6) / 0.2e1) * V_base(6) + (t40 * mrSges(7,1) - t41 * mrSges(7,2) + Ifges(7,5) * t43 + Ifges(7,6) * t42 + Ifges(7,3) * t21 / 0.2e1) * t21 + (-t15 * mrSges(10,1) + t2 * mrSges(10,3) + Ifges(10,2) * t9 / 0.2e1) * t9 + (t301 * mrSges(8,2) - t238 * mrSges(8,3) + Ifges(8,4) * t257 + Ifges(8,5) * t318 + Ifges(8,1) * t255 / 0.2e1) * t255 + (-t228 * mrSges(7,1) + t41 * mrSges(7,3) + Ifges(7,4) * t43 + Ifges(7,2) * t42 / 0.2e1) * t42 + (t238 * mrSges(8,1) - t237 * mrSges(8,2) + Ifges(8,3) * t318 / 0.2e1) * t318 + (-t99 * mrSges(5,1) + t37 * mrSges(5,3) + Ifges(5,4) * t50 + Ifges(5,2) * t49 / 0.2e1) * t49 + (V_base(3) * mrSges(1,2) - V_base(2) * mrSges(1,3) + Ifges(1,4) * V_base(5) + Ifges(1,5) * V_base(6) + Ifges(1,1) * V_base(4) / 0.2e1) * V_base(4) + (t15 * mrSges(10,2) - t1 * mrSges(10,3) + Ifges(10,4) * t9 + Ifges(10,5) * t3 + Ifges(10,1) * t10 / 0.2e1) * t10 + (t44 * mrSges(11,2) - t11 * mrSges(11,3) + Ifges(11,5) * t6 + Ifges(11,1) * t19 / 0.2e1) * t19 + (t117 * mrSges(9,1) - t118 * mrSges(9,2) + Ifges(9,3) * t80 / 0.2e1) * t80 + (t228 * mrSges(9,2) - t117 * mrSges(9,3) + Ifges(9,5) * t80 + Ifges(9,1) * t120 / 0.2e1) * t120 + (t263 * mrSges(2,1) - t264 * mrSges(2,2) + Ifges(2,3) * t319 / 0.2e1) * t319 + (t13 * mrSges(4,1) - t14 * mrSges(4,2) + Ifges(4,3) * t5 / 0.2e1) * t5 + (t36 * mrSges(5,1) - t37 * mrSges(5,2) + Ifges(5,5) * t50 + Ifges(5,6) * t49 + Ifges(5,3) * t22 / 0.2e1) * t22 + (-t44 * mrSges(11,1) + t12 * mrSges(11,3) + Ifges(11,4) * t19 + Ifges(11,6) * t6 + Ifges(11,2) * t18 / 0.2e1) * t18 + (-V_base(3) * mrSges(2,1) + t264 * mrSges(2,3) + Ifges(2,4) * t258 + Ifges(2,6) * t319 + Ifges(2,2) * t256 / 0.2e1) * t256 + (t11 * mrSges(11,1) - t12 * mrSges(11,2) + Ifges(11,3) * t6 / 0.2e1) * t6 + (-t228 * mrSges(3,1) + t104 * mrSges(3,3) + Ifges(3,4) * t106 + Ifges(3,6) * t64 + Ifges(3,2) * t105 / 0.2e1) * t105 + (-t228 * mrSges(9,1) + t118 * mrSges(9,3) + Ifges(9,4) * t120 + Ifges(9,6) * t80 + Ifges(9,2) * t119 / 0.2e1) * t119 + (-V_base(3) * mrSges(1,1) + V_base(1) * mrSges(1,3) + Ifges(1,6) * V_base(6) + Ifges(1,2) * V_base(5) / 0.2e1) * V_base(5) + (t228 * mrSges(7,2) - t40 * mrSges(7,3) + Ifges(7,1) * t43 / 0.2e1) * t43 + (t1 * mrSges(10,1) - t2 * mrSges(10,2) + Ifges(10,6) * t9 + Ifges(10,3) * t3 / 0.2e1) * t3 + (t228 * mrSges(3,2) - t103 * mrSges(3,3) + Ifges(3,5) * t64 + Ifges(3,1) * t106 / 0.2e1) * t106 + (t99 * mrSges(5,2) - t36 * mrSges(5,3) + Ifges(5,1) * t50 / 0.2e1) * t50 + m(8) * (t237 ^ 2 + t238 ^ 2 + t301 ^ 2) / 0.2e1 + m(7) * (t40 ^ 2 + t41 ^ 2 + t225) / 0.2e1 + m(9) * (t117 ^ 2 + t118 ^ 2 + t225) / 0.2e1 + m(3) * (t103 ^ 2 + t104 ^ 2 + t225) / 0.2e1 + m(6) * (t229 ^ 2 + t97 ^ 2 + t98 ^ 2) / 0.2e1 + m(11) * (t11 ^ 2 + t12 ^ 2 + t44 ^ 2) / 0.2e1 + m(10) * (t1 ^ 2 + t15 ^ 2 + t2 ^ 2) / 0.2e1;
T = t7;
