...
function Mq = picker2Dm1IC_inertiaJ_snew_vp2(qJ, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(12,1),zeros(8,1),zeros(11,1),zeros(11,3),zeros(11,6)}
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm1IC_inertiaJ_snew_vp2: qJ has to be [12x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm1IC_inertiaJ_snew_vp2: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm1IC_inertiaJ_snew_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'picker2Dm1IC_inertiaJ_snew_vp2: mrSges has to be [11x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [11 6]), ...
  'picker2Dm1IC_inertiaJ_snew_vp2: Ifges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From inertia_joint_joint_floatb_twist_snew_par2_ic_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 05:55:13
% EndTime: 2020-05-11 05:55:15
...
t321 = t326 * t542 + t326 + t332 + (t506 * (t362 * t511 - t363 * t504 - t365 * t512 + t366 * t505 - mrSges(3,2) + t546) + t513 * (mrSges(3,1) + t529 + t539 + t552) - t389 * t538 + (t350 * t557 - t388 * t506) * t556) * pkin(1) + t331 * t352;
t1 = [(t321 + t323) * t542 + t323 + t501 ^ 2 / t459 ^ 2 * Ifges(6,3) + (t393 + t328) * t333 + (t324 + t339) * t331 + Ifges(2,3) + t533 + (Ifges(9,3) * t543 + Ifges(9,3) + t533) * t543 + (((-t340 - t355) * t506 + (t327 + t337) * t557) * t556 - t501 * (-t501 * t577 - mrSges(9,2)) - t508 * (-t508 * t577 + mrSges(9,1)) + t579 * t543 + t506 * (m(3) * t574 - t345 * t504 + t346 * t511 + t347 * t505 - t348 * t512 + t419 * t503 - t420 * t510 - mrSges(3,2)) + t513 * (m(3) * t494 - t419 * t510 - t420 * t503 + mrSges(3,1) + t530 + t553) + (-t325 - t357) * t538) * pkin(1), (t324 * t368 + t328 * t381) * t573 + ((t327 * t391 + t340 * t380) * t516 - (t321 + t325) * t521) * t403; t322 * t542 + t330 * t331 + t341 * t333 + (t339 * t368 + t381 * t393) * t573 + (-t338 * t538 + (t329 * t557 - t336 * t506) * t556) * pkin(1) + ((t337 * t391 + t355 * t380) * t516 - (t323 + t357) * t521) * t403, Ifges(8,3) + (t330 * t368 + t341 * t381) * t573 + ((t329 * t391 + t336 * t380) * t516 - (t322 + t338) * t521) * t403;];
Mq = t1;
