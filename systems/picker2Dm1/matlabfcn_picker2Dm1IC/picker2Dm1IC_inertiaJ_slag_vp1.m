...
function Mq = picker2Dm1IC_inertiaJ_slag_vp1(qJ, ...
  pkin, m, rSges, Icges)
%% Coder Information
%#codegen
%$cgargs {zeros(12,1),zeros(8,1),zeros(11,1),zeros(11,3),zeros(11,6)}
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm1IC_inertiaJ_slag_vp1: qJ has to be [12x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm1IC_inertiaJ_slag_vp1: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm1IC_inertiaJ_slag_vp1: m has to be [11x1] (double)'); 
assert(isreal(rSges) && all(size(rSges) == [11,3]), ...
  'picker2Dm1IC_inertiaJ_slag_vp1: rSges has to be [11x3] (double)');
assert(isreal(Icges) && all(size(Icges) == [11 6]), ...
  'picker2Dm1IC_inertiaJ_slag_vp1: Icges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From inertia_joint_joint_floatb_twist_par1_ic_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 05:55:01
% EndTime: 2020-05-11 05:55:02
...
t205 = t210 - t369;
t200 = t205 - t373;
t170 = m(11) * (t199 * t224 + t200 * t226) + Icges(11,3);
...
t157 = t197 + m(3) * (t246 ^ 2 + t248 ^ 2) + m(10) * (t207 ^ 2 + t208 ^ 2) + m(11) * (t204 ^ 2 + t205 ^ 2) + m(4) * (t220 ^ 2 + t221 ^ 2) + m(5) * (t218 ^ 2 + t219 ^ 2) + t332;
t156 = t159 * t196;
...
t144 = (-t176 * t342 + (t162 * t362 - t175 * t323) * t361) * pkin(1) + t156 + t158 * t163 + t157 * t347 + t149;
t1 = [t206 ^ 2 * t327 ^ 2 * t236 ^ 2 * m(9) * (t245 ^ 2 + t247 ^ 2) + ((-t147 - t172) * t342 + ((-t155 - t170) * t323 + (t148 + t160) * t362) * t361) * pkin(1) + m(2) * (t258 ^ 2 + t260 ^ 2) + m(9) * (t232 ^ 2 + t234 ^ 2) + m(3) * (t233 ^ 2 + t235 ^ 2) + m(7) * (t222 ^ 2 + t223 ^ 2) + m(5) * (t211 ^ 2 + t213 ^ 2) + m(4) * (t212 ^ 2 + t214 ^ 2) + m(11) * (t199 ^ 2 + t200 ^ 2) + m(10) * (t201 ^ 2 + t202 ^ 2) + (t185 + t152) * t159 + (t146 + t161) * t158 + (0.2e1 * m(9) * (t232 * t245 + t234 * t247) + (0.2e1 + t348) * Icges(9,3)) * t348 + (t144 + t149) * t347 + Icges(2,3) + Icges(9,3) + t332 + (Icges(6,3) + m(6) * (t243 ^ 2 + t244 ^ 2)) * t320 ^ 2 / t276 ^ 2, (t146 * t189 + t152 * t194) * t371 + ((t148 * t198 + t155 * t193) * t328 - (t144 + t147) * t334) * t217; t145 * t347 + t151 * t158 + t164 * t159 + (t161 * t189 + t185 * t194) * t371 + (-t154 * t342 + (t150 * t362 - t153 * t323) * t361) * pkin(1) + ((t160 * t198 + t170 * t193) * t328 - (t149 + t172) * t334) * t217, Icges(8,3) + m(8) * (t257 ^ 2 + t259 ^ 2) + (t151 * t189 + t164 * t194) * t371 + ((t150 * t198 + t153 * t193) * t328 - (t145 + t154) * t334) * t217;];
Mq = t1;
