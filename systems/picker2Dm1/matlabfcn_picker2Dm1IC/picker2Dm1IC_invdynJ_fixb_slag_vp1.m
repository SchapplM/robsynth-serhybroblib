...
function tau = picker2Dm1IC_invdynJ_fixb_slag_vp1(qJ, qJD, qJDD, g, ...
  pkin, m, rSges, Icges)
%% Coder Information
%#codegen
...
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm1IC_invdynJ_fixb_slag_vp1: qJ has to be [12x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [12 1]), ...
  'picker2Dm1IC_invdynJ_fixb_slag_vp1: qJD has to be [12x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [12 1]), ...
  'picker2Dm1IC_invdynJ_fixb_slag_vp1: qJDD has to be [12x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'picker2Dm1IC_invdynJ_fixb_slag_vp1: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm1IC_invdynJ_fixb_slag_vp1: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm1IC_invdynJ_fixb_slag_vp1: m has to be [11x1] (double)'); 
assert(isreal(rSges) && all(size(rSges) == [11,3]), ...
  'picker2Dm1IC_invdynJ_fixb_slag_vp1: rSges has to be [11x3] (double)');
assert(isreal(Icges) && all(size(Icges) == [11 6]), ...
  'picker2Dm1IC_invdynJ_fixb_slag_vp1: Icges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From invdyn_fixb_par1_ic_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 05:54:47
% EndTime: 2020-05-11 05:54:52
...
t7 = [t189 + (-t279 * pkin(5) + (-cos(qJ(8) + 0.2e1 * qJ(1)) + cos((2 * pkin(8)) + (2 * qJ(5)) + qJ(8))) * pkin(1)) * t237 / t279 * (t189 + (-t66 * t81 + t68 * t300 + (t66 * t222 - g(2) + t21) * t111 + (-t68 * t222 + g(1) - t19) * t109) * m(9)) - m(9) * (g(1) * t91 + g(2) * t93) + m(9) * (t19 * t91 + t21 * t93) + t249 + sin(qJ(8)) / sin(-qJ(8) + t268) * (Icges(6,3) * qJDD(5) + ((t107 ^ 2 + t108 ^ 2) * qJDD(5) + g(1) * t107 - g(2) * t108) * m(6)) - t230 * t4 * t275 + Icges(2,3) * qJDD(1) + (t25 * (t244 + t45) - t26 * (t250 + t44) + t333 * (t43 - t323) + t334 * (t218 + t42)) * m(10) + (t352 * (t102 - t323) + t353 * (t218 - t99)) * m(7) + (t28 * (t245 + t61) - t30 * (t285 + t60) + t336 * (t72 - t323) + t338 * (t218 + t71)) * m(5) + (t335 * (t74 - t323) + t337 * (t218 + t73) + (-t31 + t246 - t63) * t29) * m(4) + (t346 * (t112 - t323) + t347 * (t110 + t218) + (t67 - t196 - t82) * t69) * m(3) + (t339 * (t39 - t323) + t340 * (t218 + t38)) * m(11) + ((qJDD(1) * t256 + g(2)) * t256 + (qJDD(1) * t142 - g(1)) * t142) * m(2) + (((t277 * t89 + t278 * t88) * t303 + (-(sin(t213) - sin(t212)) * t125 - (cos(t213) - cos(t212)) * t124) * t305) * t6 + ((-t282 * t89 - t283 * t88) * t303 + ((sin(t173) - sin(t172)) * t125 + (cos(t173) - cos(t172)) * t124) * t305) * t3) * pkin(2) + ((-pkin(1) * t207 - pkin(3) * t229) * t225 * t1 - pkin(1) * (pkin(3) * (cos(t261) - cos(t260)) + (cos(-qJ(2) + t255) - cos(qJ(2) + t254)) * pkin(5)) * t237 / (cos(t255) - cos(t254)) * t5 + (pkin(3) * t230 + pkin(4) * t207) * t2 * t275) * t239; Icges(8,3) * qJDD(7) + ((-t228 * t282 + t232 * t283) * t3 + (t228 * t277 - t232 * t278) * t6) * pkin(2) * t37 + ((t141 ^ 2 + t143 ^ 2) * qJDD(7) - g(1) * t143 - g(2) * t141) * m(8) + (-(t1 + t5) * t252 + ((pkin(4) * t252 + t332) * t2 + (pkin(4) * t253 - t332) * t4) * t238) / t253;];
tau = t7(:);
