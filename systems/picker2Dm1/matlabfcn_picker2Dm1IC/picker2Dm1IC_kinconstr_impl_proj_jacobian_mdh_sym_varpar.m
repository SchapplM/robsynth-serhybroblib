...
function B21 = picker2Dm1IC_kinconstr_impl_proj_jacobian_mdh_sym_varpar(qJ, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(12,1),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm1IC_kinconstr_impl_proj_jacobian_mdh_sym_varpar: qJ has to be [12x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm1IC_kinconstr_impl_proj_jacobian_mdh_sym_varpar: pkin has to be [8x1] (double)');

%% Symbolic Calculation
% From kinconstr_impl_projection_jacobian_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 05:54:44
% EndTime: 2020-05-11 05:54:44
...
t118 = t179 * t121;
t1 = [(-t157 * pkin(1) - t169 * pkin(3)) * t164 * t175, -t118; ((-t195 * t122 - t194 * t123) * t199 + ((sin(t148) - sin(t147)) * t129 + (cos(t148) - cos(t147)) * t128) * t200) * pkin(2), (-t194 * t168 + t195 * t171) * t202; (t170 * pkin(3) + t157 * pkin(4)) * t175 * t189, (t179 * pkin(4) + t203) * t198; t167 * t140, 0; ((t124 * t122 + t125 * t123) * t199 + (-t129 * t126 - t128 * t127) * t200) * pkin(2), -t119 * t202; (-t191 * pkin(5) + (-cos(qJ(8) + 0.2e1 * qJ(1)) + cos((2 * pkin(8)) + (2 * qJ(5)) + qJ(8))) * pkin(1)) * t173 / t191, 0; -pkin(1) * (pkin(3) * (cos(t184) - cos(t183)) + (cos(-qJ(2) + t182) - cos(qJ(2) + t181)) * pkin(5)) * t175 * t173 / (cos(t182) - cos(t181)), -t118; -t170 * t189, (t180 * pkin(4) - t203) * t198; (pkin(5) * t167 - pkin(1) * sin(t185)) * t173 * t140, 0; (t129 * (pkin(2) * t126 + (-sin(t154) + sin(t153)) * pkin(6)) + t128 * (pkin(2) * t127 + (-cos(t154) + cos(t153)) * pkin(6))) * t200 + (-(pkin(2) * t124 + t193 * pkin(6)) * t122 - (pkin(2) * t125 + t192 * pkin(6)) * t123) * t199, (pkin(2) * t119 + (-t192 * t168 + t193 * t171) * pkin(6)) * t120;];
B21 = t1;
