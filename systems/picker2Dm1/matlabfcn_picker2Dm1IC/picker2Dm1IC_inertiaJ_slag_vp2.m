...
function Mq = picker2Dm1IC_inertiaJ_slag_vp2(qJ, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(12,1),zeros(8,1),zeros(11,1),zeros(11,3),zeros(11,6)}
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm1IC_inertiaJ_slag_vp2: qJ has to be [12x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm1IC_inertiaJ_slag_vp2: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm1IC_inertiaJ_slag_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'picker2Dm1IC_inertiaJ_slag_vp2: mrSges has to be [11x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [11 6]), ...
  'picker2Dm1IC_inertiaJ_slag_vp2: Ifges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From inertia_joint_joint_floatb_twist_par2_ic_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 05:55:09
% EndTime: 2020-05-11 05:55:10
...
t279 = m(5) * (t196 * t267 + t199 * t260) * pkin(3) + t240 + t241 + t280 + (-t172 - t198) * mrSges(10,2) + (-t170 - t194) * mrSges(11,2) + (-t199 - t340) * mrSges(5,2) + m(4) * (-t197 * t268 - t200 * t261) * pkin(2) + t177 + m(10) * (t195 * t171 + t198 * t172) + m(11) * (t193 * t169 + t194 * t170) + Ifges(3,3) + t314 + t346 + t347;
t250 = t257 ^ 2;
...
t148 = 0.2e1 * t184 + m(4) * (t261 ^ 2 + t268 ^ 2) * pkin(2) ^ 2 + 0.2e1 * t239 + 0.2e1 * t240 - 0.2e1 * t302 - 0.2e1 * t304 + m(10) * (t195 ^ 2 + t198 ^ 2) + m(11) * (t193 ^ 2 + t194 ^ 2) + m(5) * (t260 ^ 2 + t267 ^ 2) * pkin(3) ^ 2 + 0.2e1 * t187 + t283 - 0.2e1 * t320 - 0.2e1 * t334;
...
t132 = t148 * t297 + t279 + t142 + (-t175 * t293 - t330 + (t153 * t317 - t173 * t262) * t316) * pkin(1) + t141 * t154;
t1 = [(t132 + t135) * t297 + (t345 + (0.2e1 + t298) * Ifges(9,3)) * t298 + m(5) * (t196 ^ 2 + t199 ^ 2) + m(4) * (t197 ^ 2 + t200 ^ 2) + m(7) * (t203 ^ 2 + t204 ^ 2) + m(11) * (t169 ^ 2 + t170 ^ 2) + m(10) * (t171 ^ 2 + t172 ^ 2) + 0.2e1 * t241 + (t305 - 0.2e1 * t330 + (t305 * t322 + (-t136 - t158) * t299) * t272 + ((-t149 - t157) * t262 + (t137 + t144) * t317) * t316 + (m(9) * (t264 ^ 2 + t250) + m(3) * (t262 ^ 2 + t269 ^ 2)) * pkin(1)) * pkin(1) + t250 / t219 ^ 2 * Ifges(6,3) + (t138 + t177) * t143 + (t134 + t145) * t141 + 0.2e1 * t201 + 0.2e1 * t189 + 0.2e1 * t165 + 0.2e1 * t166 + 0.2e1 * t188 + t283 + t345 - 0.2e1 * t325 + Ifges(2,3) + Ifges(9,3) - 0.2e1 * t331 - 0.2e1 * t332 - 0.2e1 * t333 - 0.2e1 * t335, (t134 * t161 + t138 * t168) * t342 + ((t137 * t176 + t149 * t167) * t274 - (t132 + t136) * t285) * t182; t133 * t297 + t140 * t141 + t152 * t143 + (t145 * t161 + t168 * t177) * t342 + (-t147 * t293 + (t139 * t317 - t146 * t262) * t316) * pkin(1) + ((t144 * t176 + t157 * t167) * t274 - (t135 + t158) * t285) * t182, Ifges(8,3) + (t140 * t161 + t152 * t168) * t342 + ((t139 * t176 + t146 * t167) * t274 - (t133 + t147) * t285) * t182;];
Mq = t1;
