...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = picker2Dm1DE2_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(9,1)}
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'picker2Dm1DE2_pkin2mdhparam: Kinematic parameters pkin have to be [9x1] (double)');
