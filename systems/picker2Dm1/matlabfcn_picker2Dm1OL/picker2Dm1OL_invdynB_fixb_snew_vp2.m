...
function tauB = picker2Dm1OL_invdynB_fixb_snew_vp2(qJ, qJD, qJDD, g, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
...
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm1OL_invdynB_fixb_snew_vp2: qJ has to be [12x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [12 1]), ...
  'picker2Dm1OL_invdynB_fixb_snew_vp2: qJD has to be [12x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [12 1]), ...
  'picker2Dm1OL_invdynB_fixb_snew_vp2: qJDD has to be [12x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'picker2Dm1OL_invdynB_fixb_snew_vp2: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm1OL_invdynB_fixb_snew_vp2: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm1OL_invdynB_fixb_snew_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'picker2Dm1OL_invdynB_fixb_snew_vp2: mrSges has to be [11x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [11 6]), ...
  'picker2Dm1OL_invdynB_fixb_snew_vp2: Ifges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From invdyn_fixb_NewtonEuler_linkframe_tauB_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 05:45:08
% EndTime: 2020-05-11 05:45:09
...
t1 = [-m(1) * g(1) + t512 * t390 - t521 * t391 + t506 * t463 + t515 * t464 + t531; -m(1) * g(2) - t521 * t390 - t512 * t391 + t530 + t532; (-m(1) - m(2) - m(6) - m(8) - t529) * g(3); mrSges(1,3) * g(2) + t512 * t388 - t521 * t389 - t468 * t442 + t469 * t443 + t515 * t461 + t506 * t462 + (-t501 * t536 - mrSges(1,2)) * g(3); -mrSges(1,3) * g(1) - t521 * t388 - t512 * t389 + t469 * t442 + t468 * t443 + t506 * t461 - t515 * t462 + (m(8) * pkin(7) + t503 * t536 + mrSges(1,1)) * g(3); (-t501 * t531 + t503 * t532) * pkin(5) + pkin(3) * t533 + pkin(7) * t530 + t525 * pkin(1) + pkin(6) * t526 + pkin(4) * t527 + pkin(2) * t528 + Ifges(2,3) * qJDD(1) + Ifges(6,3) * qJDD(5) + Ifges(8,3) * qJDD(7) + Ifges(7,3) * t485 + Ifges(5,3) * t486 + Ifges(4,3) * t487 + Ifges(9,3) * t496 + Ifges(3,3) * t497 + Ifges(10,3) * t478 + Ifges(11,3) * t476 - mrSges(8,2) * t472 + mrSges(2,1) * t473 + mrSges(8,1) * t474 - mrSges(2,2) * t475 + mrSges(3,1) * t455 - mrSges(9,2) * t456 - mrSges(3,2) * t457 + mrSges(6,1) * t458 - mrSges(6,2) * t459 + mrSges(9,1) * t454 + mrSges(5,1) * t428 + mrSges(4,1) * t429 - mrSges(5,2) * t430 - mrSges(4,2) * t431 + mrSges(7,1) * t432 - mrSges(7,2) * t433 + mrSges(11,1) * t416 - mrSges(11,2) * t417 + mrSges(10,1) * t418 - mrSges(10,2) * t419 - mrSges(1,1) * g(2) + mrSges(1,2) * g(1);];
tauB = t1;
