...
function T = picker2Dm1OL_energykin_floatb_twist_slag_vp1(qJ, qJD, V_base, ...
  pkin, m, rSges, Icges)
%% Coder Information
%#codegen
%$cgargs {zeros(12,1),zeros(12,1),zeros(6,1),zeros(8,1),zeros(11,1),zeros(11,3),zeros(11,6)}
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm1OL_energykin_floatb_twist_slag_vp1: qJ has to be [12x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [12 1]), ...
  'picker2Dm1OL_energykin_floatb_twist_slag_vp1: qJD has to be [12x1] (double)');
assert(isreal(V_base) && all(size(V_base) == [6 1]), ...
  'picker2Dm1OL_energykin_floatb_twist_slag_vp1: V_base has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm1OL_energykin_floatb_twist_slag_vp1: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm1OL_energykin_floatb_twist_slag_vp1: m has to be [11x1] (double)'); 
assert(isreal(rSges) && all(size(rSges) == [11,3]), ...
  'picker2Dm1OL_energykin_floatb_twist_slag_vp1: rSges has to be [11x3] (double)');
assert(isreal(Icges) && all(size(Icges) == [11 6]), ...
  'picker2Dm1OL_energykin_floatb_twist_slag_vp1: Icges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From energy_kinetic_floatb_twist_worldframe_par1_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 05:44:50
% EndTime: 2020-05-11 05:44:53
...
t1 = (Icges(1,6) * V_base(6) + (-Icges(10,5) * t197 - Icges(10,6) * t198) * t186 + (Icges(7,5) * t204 + Icges(7,6) * t207) * t192 + (-Icges(5,5) * t205 - Icges(5,6) * t208) * t193 + (Icges(4,5) * t206 + Icges(4,6) * t209) * t194 + (Icges(6,5) * t212 + Icges(6,6) * t213) * t215 + (Icges(9,5) * t217 + Icges(9,6) * t219) * t202 + (-Icges(3,5) * t218 - Icges(3,6) * t220) * t203 + (-Icges(8,5) * t232 + Icges(8,6) * t230) * t214 + (-Icges(2,5) * t231 - Icges(2,6) * t233) * t216 + (Icges(11,5) * t195 + Icges(11,6) * t196) * t185 + (t151 * t273 + t155 * t217 / 0.2e1 + t153 * t272 - t157 * t218 / 0.2e1 + t141 * t274 + t143 * t212 / 0.2e1 + t123 * t276 - t129 * t205 / 0.2e1 + t125 * t275 + t131 * t206 / 0.2e1 + t121 * t277 + t127 * t204 / 0.2e1 + t109 * t278 - t111 * t197 / 0.2e1 + t101 * t279 + t103 * t195 / 0.2e1 + Icges(1,2) / 0.2e1 + t174 * t270 - t231 * t178 / 0.2e1 + t173 * t271 - t177 * t232 / 0.2e1) * V_base(5)) * V_base(5) + m(11) * (t69 ^ 2 + t73 ^ 2 + t74 ^ 2) / 0.2e1 + m(10) * (t70 ^ 2 + t75 ^ 2 + t76 ^ 2) / 0.2e1 + m(5) * (t71 ^ 2 + t78 ^ 2 + t80 ^ 2) / 0.2e1 + m(4) * (t72 ^ 2 + t79 ^ 2 + t81 ^ 2) / 0.2e1 + Icges(5,3) * t193 ^ 2 / 0.2e1 + Icges(10,3) * t186 ^ 2 / 0.2e1 + Icges(6,3) * t215 ^ 2 / 0.2e1 + Icges(4,3) * t194 ^ 2 / 0.2e1 + m(1) * (t165 ^ 2 + t166 ^ 2 + t167 ^ 2) / 0.2e1 + m(8) * (t93 ^ 2 + t95 ^ 2 + t97 ^ 2) / 0.2e1 + m(2) * (t94 ^ 2 + t96 ^ 2 + t98 ^ 2) / 0.2e1 + m(7) * (t77 ^ 2 + t85 ^ 2 + t86 ^ 2) / 0.2e1 + m(9) * (t83 ^ 2 + t87 ^ 2 + t89 ^ 2) / 0.2e1 + m(3) * (t84 ^ 2 + t88 ^ 2 + t90 ^ 2) / 0.2e1 + m(6) * (t82 ^ 2 + t91 ^ 2 + t92 ^ 2) / 0.2e1 + Icges(2,3) * t216 ^ 2 / 0.2e1 + Icges(8,3) * t214 ^ 2 / 0.2e1 + Icges(1,3) * V_base(6) ^ 2 / 0.2e1 + Icges(11,3) * t185 ^ 2 / 0.2e1 + Icges(3,3) * t203 ^ 2 / 0.2e1 + Icges(9,3) * t202 ^ 2 / 0.2e1 + Icges(7,3) * t192 ^ 2 / 0.2e1 + (((-t175 - t178) * t233 + (t173 - t176) * t232 + (t174 - t179) * t231 + (t177 + t172) * t230 + (-t154 - t157) * t220 + (t152 + t155) * t219 + (-t158 + t153) * t218 + (t156 - t151) * t217 + (t142 + t143) * t213 + (t144 - t141) * t212 + (t126 + t131) * t209 + (-t124 - t129) * t208 + (t127 + t122) * t207 + (t132 - t125) * t206 + (-t130 + t123) * t205 + (-t121 + t128) * t204 + (-t111 - t110) * t198 + (t109 - t112) * t197 + (t102 + t103) * t196 + (t104 - t101) * t195) * V_base(5) / 0.2e1 + Icges(1,5) * V_base(6) + Icges(1,4) * V_base(5) + (Icges(11,5) * t196 - Icges(11,6) * t195) * t185 + (-Icges(10,5) * t198 + Icges(10,6) * t197) * t186 + (Icges(7,5) * t207 - Icges(7,6) * t204) * t192 + (-Icges(5,5) * t208 + Icges(5,6) * t205) * t193 + (Icges(4,5) * t209 - Icges(4,6) * t206) * t194 + (Icges(6,5) * t213 - Icges(6,6) * t212) * t215 + (Icges(9,5) * t219 - Icges(9,6) * t217) * t202 + (-Icges(3,5) * t220 + Icges(3,6) * t218) * t203 + (Icges(8,5) * t230 + Icges(8,6) * t232) * t214 + (-Icges(2,5) * t233 + Icges(2,6) * t231) * t216 + (-t152 * t217 / 0.2e1 + t156 * t273 + t154 * t218 / 0.2e1 + t158 * t272 - t142 * t212 / 0.2e1 + t144 * t274 + t124 * t205 / 0.2e1 + t130 * t276 - t126 * t206 / 0.2e1 + t132 * t275 - t122 * t204 / 0.2e1 + t128 * t277 + t110 * t197 / 0.2e1 + t112 * t278 - t102 * t195 / 0.2e1 + t104 * t279 + Icges(1,1) / 0.2e1 + t231 * t175 / 0.2e1 + t179 * t270 + t172 * t232 / 0.2e1 + t176 * t271) * V_base(4)) * V_base(4);
T = t1;
