...
function tauc = picker2Dm1OL_coriolisvecJ_fixb_slag_vp2(qJ, qJD, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(12,1),zeros(12,1),zeros(8,1),zeros(11,1),zeros(11,3),zeros(11,6)}
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm1OL_coriolisvecJ_fixb_slag_vp2: qJ has to be [12x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [12 1]), ...
  'picker2Dm1OL_coriolisvecJ_fixb_slag_vp2: qJD has to be [12x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm1OL_coriolisvecJ_fixb_slag_vp2: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm1OL_coriolisvecJ_fixb_slag_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'picker2Dm1OL_coriolisvecJ_fixb_slag_vp2: mrSges has to be [11x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [11 6]), ...
  'picker2Dm1OL_coriolisvecJ_fixb_slag_vp2: Ifges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From coriolisvec_joint_fixb_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 05:44:58
% EndTime: 2020-05-11 05:45:04
...
t11 = [t131 - t9 * t69 * mrSges(10,2) + t10 * t138 - t41 * t144 + t42 * t137 - t37 * t76 * mrSges(5,2) + t38 * t136 - t39 * t77 * mrSges(4,2) + t40 * t147 - t7 * t68 * mrSges(11,2) + m(4) * (t114 * t25 + t24 * t59 - t49 * t39 + t47 * t40) + m(5) * (t109 * t23 + t22 * t58 + t48 * t37 + t46 * t38) + m(10) * (t14 * t10 - t105 * t5 + t106 * t6 - t15 * t9) + m(11) * (-t107 * t3 + t108 * t4 + t12 * t8 - t13 * t7) + t95 + t8 * t127 + m(7) * (-t55 * t41 + t52 * t42 + (t103 * t32 - t104 * t31) * pkin(1)) + t162 * t79 - (t80 + qJD(1)) * t163 * pkin(1) * qJD(2); 0.2e1 * ((qJD(4) * t48 + t23) * t92 * t155 + (m(11) * (-t3 * t82 + t4 * t81) / 0.2e1 + (-qJD(4) * t46 + t22) * t155) * t86) * pkin(3) + m(11) * (t12 * t34 - t13 * t33 + t158 * t70) + m(10) * (t14 * t36 - t15 * t35 + t159 * t71) + ((t27 - t33) * mrSges(11,2) + (-t26 + t34) * mrSges(11,1)) * t68 + ((t29 - t35) * mrSges(10,2) + (-t28 + t36) * mrSges(10,1)) * t69 + (-t53 * mrSges(5,1) + t56 * mrSges(5,2) + (-mrSges(5,1) * t86 - mrSges(5,2) * t92) * qJD(4) * pkin(3)) * t76 + (-t54 * mrSges(4,1) + t57 * mrSges(4,2) + (mrSges(4,1) * t87 + mrSges(4,2) * t93) * qJD(3) * pkin(2)) * t77 - m(5) * (t46 * t53 + t48 * t56) - m(4) * (t47 * t54 - t49 * t57) - m(11) * (t12 * t26 - t13 * t27) - m(10) * (t14 * t28 - t15 * t29) + 0.2e1 * ((qJD(3) * t49 - t25) * t93 * t156 + (m(10) * (t5 * t89 - t6 * t83) / 0.2e1 + (qJD(3) * t47 - t24) * t156) * t87) * pkin(2) + t95 + t163 * t130 * (-qJD(2) + t80) + t161; -m(10) * (t14 * t18 - t15 * t19) - t49 * t147 - t18 * t138 + (t19 * t69 - t5) * mrSges(10,2) + (t47 * t77 - t24) * mrSges(4,2) + (m(10) * ((t14 * t83 + t15 * t89) * qJD(9) + t159) + (mrSges(10,1) * t83 + mrSges(10,2) * t89) * qJD(9) * t69) * pkin(6) + t149; t48 * t136 - t16 * t127 - m(11) * (t12 * t16 - t13 * t17) + (t46 * t76 - t22) * mrSges(5,2) + (t17 * t68 - t3) * mrSges(11,2) + (m(11) * ((t12 * t81 + t13 * t82) * qJD(10) + t158) + (mrSges(11,1) * t81 + mrSges(11,2) * t82) * qJD(10) * t68) * pkin(4) + t150; 0; t115 + t161; 0; -t130 * t164 * t79 + t131; -t15 * t138 + t2 + (t14 * t69 - t5) * mrSges(10,2); -t13 * t127 + t1 + (t12 * t68 - t3) * mrSges(11,2); 0; 0;];
tauc = t11(:);
