...
function [q, Phi] = fivebar1DE2_invkin_eulangresidual(xE_soll, q0, s)
...
for rr = 0:retry_limit % Schleife über Neu-Anfänge der Berechnung
  ...
  for jj = 2:n_max % Schleife über iteratives Annähern mit Newton-Verfahren
    ...
    Jdk_voll = fivebar1DE2_constr2grad(q1, xE_soll, pkin, T_N_E, phiconv_W_E, I_EElink, reci);
    % Zwangsbedingungen
    Phi_voll = fivebar1DE2_constr2(q1, xE_soll, pkin, T_N_E, phiconv_W_E, I_EElink, reci);
