...
RS = hybroblib_create_robot_class('fivebar1', 'TE', 'fivebar1Bsp1');
...
QE = [RS.qlim(1,1), RS.qlim(2,1); ...
      RS.qlim(1,2), RS.qlim(2,1); ...
      RS.qlim(1,2), RS.qlim(2,2); ...
      RS.qlim(1,1), RS.qlim(2,2); ...
      RS.qlim(1,1), RS.qlim(2,1); ...
      RS.qlim(1,2), RS.qlim(2,2)];
...
q_test = Q_data(find(I_iO==1,1),1:2)';
