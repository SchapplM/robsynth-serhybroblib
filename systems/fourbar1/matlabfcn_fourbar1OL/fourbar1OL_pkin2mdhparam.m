...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = fourbar1OL_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(4,1)}
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1OL_pkin2mdhparam: Kinematic parameters pkin have to be [4x1] (double)');
