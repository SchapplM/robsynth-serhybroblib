...
function tauJB = fourbar1OL_invdynJB_fixb_snew_vp2(qJ, qJD, qJDD, g, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(4,1),zeros(4,1),zeros(3,1),zeros(4,1),zeros(4,1),zeros(4,3),zeros(4,6)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'fourbar1OL_invdynJB_fixb_snew_vp2: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'fourbar1OL_invdynJB_fixb_snew_vp2: qJD has to be [4x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [4 1]), ...
  'fourbar1OL_invdynJB_fixb_snew_vp2: qJDD has to be [4x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'fourbar1OL_invdynJB_fixb_snew_vp2: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1OL_invdynJB_fixb_snew_vp2: pkin has to be [4x1] (double)');
assert(isreal(m) && all(size(m) == [4 1]), ...
  'fourbar1OL_invdynJB_fixb_snew_vp2: m has to be [4x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [4,3]), ...
  'fourbar1OL_invdynJB_fixb_snew_vp2: mrSges has to be [4x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [4 6]), ...
  'fourbar1OL_invdynJB_fixb_snew_vp2: Ifges has to be [4x6] (double)'); 
...
t1 = [-t214 * g(1) + t184 * qJDD(1) + t187 * qJDD(2) - t202 * qJDD(3) - t183 * t225 - t246 * t185 - t208 * t223; -t214 * g(2) + t183 * qJDD(1) + t185 * qJDD(2) + t184 * t225 + t246 * t187 + t250; -t214 * g(3); t211 * g(2) - (-t247 - t253) * g(3) + t182 * qJDD(1) - t228 * t225 + t186 * qJDD(2) + t203 * qJDD(3) + t201 * t223 + t246 * t227; -(-m(4) * pkin(1) - t245 - t251) * g(3) - t211 * g(1) + t228 * qJDD(1) + t182 * t225 - t227 * qJDD(2) - t201 * qJDD(3) + t203 * t223 + t246 * t186; -t245 * g(2) - t247 * g(1) + t235 + (-g(1) * t252 - g(2) * t248) * t217 + (-m(4) * g(2) + t250) * pkin(1) + t230; -t184 * g(1) - t183 * g(2) + t230; Ifges(3,3) * (qJDD(1) + qJDD(2)) + mrSges(3,1) * (-t219 * t197 + t216 * t198) - mrSges(3,2) * (-t216 * t197 - t219 * t198); t202 * g(1) - t208 * g(2) + t235; 0;];
tauJB = t1;
