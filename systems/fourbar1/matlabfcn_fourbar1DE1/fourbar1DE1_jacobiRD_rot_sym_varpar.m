...
function JRD_rot = fourbar1DE1_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(1,1),zeros(1,1),uint8(0),zeros(4,1)}
assert(isreal(qJ) && all(size(qJ) == [1 1]), ...
  'fourbar1DE1_jacobiRD_rot_sym_varpar: qJ has to be [1x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [1 1]), ...
  'fourbar1DE1_jacobiRD_rot_sym_varpar: qJD has to be [1x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'fourbar1DE1_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1DE1_jacobiRD_rot_sym_varpar: pkin has to be [4x1] (double)');
JRD_rot=NaN(9,1);
if link_index == 0
...
elseif link_index == 2
	...
	t307 = t317 * t312 * t372;
	t306 = (pkin(1) * t354 + t320 + (t332 * t348 + (t333 * t361 - t366) * qJD(1) + (t332 * t311 / 0.2e1 + t349 * t333) * t376) * pkin(2)) * t358 - (t321 + (t365 + (t361 + t382) * t332) * pkin(2)) * t347 - (-0.2e1 * t329 * pkin(2) * t360 + t307 - t363) * t352 + t380 * (-t329 * t324 + t315);
