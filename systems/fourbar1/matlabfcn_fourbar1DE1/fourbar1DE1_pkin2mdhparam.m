...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = fourbar1DE1_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(4,1)}
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1DE1_pkin2mdhparam: Kinematic parameters pkin have to be [4x1] (double)');
...
t1 = [0; pkin(2); pkin(1); pkin(3); pkin(4);];
a_mdh = t1;
