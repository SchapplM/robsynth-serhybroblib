...
function JaD_transl = fourbar1DE1_jacobiaD_transl_sym_varpar(qJ, qJD, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [1 1]), ...
  'fourbar1DE1_jacobiaD_transl_sym_varpar: qJ has to be [1x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [1 1]), ...
  'fourbar1DE1_jacobiaD_transl_sym_varpar: qJD has to be [1x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'fourbar1DE1_jacobiaD_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'fourbar1DE1_jacobiaD_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1DE1_jacobiaD_transl_sym_varpar: pkin has to be [4x1] (double)');
JaD_transl=NaN(3,1);
if link_index == 0
...
elseif link_index == 2
	...
	% OptimizationMode: 2
	% StartTime: 2020-04-24 19:57:35
	% EndTime: 2020-04-24 19:57:35
	...
	t297 = 0.2e1 * t233;
	t300 = -(t237 + (t249 * t254 + (t282 + t303) * t248) * pkin(2)) * t266 - (t281 * t282 + t223 - t285) * t272 + (pkin(1) * t275 + t236 + (t248 * t268 + (t249 * t282 - t287) * qJD(1) + (t248 * t227 / 0.2e1 + t269 * t249) * t297) * pkin(2)) * t279 + t305 * (-t240 * t245 + t231);
	t288 = t245 * t227;
