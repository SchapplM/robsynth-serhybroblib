...
function W = fourbar1DE1_kinconstr_expl_jacobian_mdh_sym_varpar(qJ, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(1,1),zeros(4,1)}
assert(isreal(qJ) && all(size(qJ) == [1 1]), ...
  'fourbar1DE1_kinconstr_expl_jacobian_mdh_sym_varpar: qJ has to be [1x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1DE1_kinconstr_expl_jacobian_mdh_sym_varpar: pkin has to be [4x1] (double)');
...
t1 = [1; -((pkin(1) - t45) * t40 + (t41 - t42) * t46) * pkin(1) * t44; pkin(2) * ((-pkin(1) * t35 + pkin(2)) * t40 + pkin(1) * t34 * (t41 + t42)) * t44; 0.2e1 * pkin(1) * t29 * t46; 0;];
W = t1;
