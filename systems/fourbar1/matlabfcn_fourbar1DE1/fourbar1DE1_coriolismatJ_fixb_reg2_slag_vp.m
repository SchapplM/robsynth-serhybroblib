...
function cmat_reg = fourbar1DE1_coriolismatJ_fixb_reg2_slag_vp(qJ, qJD, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(1,1),zeros(1,1),zeros(4,1)}
assert(isreal(qJ) && all(size(qJ) == [1 1]), ...
  'fourbar1DE1_coriolismatJ_fixb_reg2_slag_vp: qJ has to be [1x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [1 1]), ...
  'fourbar1DE1_coriolismatJ_fixb_reg2_slag_vp: qJD has to be [1x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1DE1_coriolismatJ_fixb_reg2_slag_vp: pkin has to be [4x1] (double)');

%% Symbolic Calculation
% From coriolismat_joint_fixb_regressor_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-24 19:57:32
...
t39 = t45 ^ 2;
t59 = pkin(1) * t57;
t73 = (-t50 / 0.2e1 + t85) * t59 * pkin(2) * t39;
t72 = 0.2e1 * t75;
t71 = t12 * t75;
t70 = 0.1e1 / t22 ^ 2 * t76;
t19 = 0.1e1 / t22;
