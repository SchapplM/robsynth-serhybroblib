...
function JaD_transl = fourbar1TE_jacobiaD_transl_sym_varpar(qJ, qJD, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [1 1]), ...
  'fourbar1TE_jacobiaD_transl_sym_varpar: qJ has to be [1x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [1 1]), ...
  'fourbar1TE_jacobiaD_transl_sym_varpar: qJD has to be [1x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'fourbar1TE_jacobiaD_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'fourbar1TE_jacobiaD_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1TE_jacobiaD_transl_sym_varpar: pkin has to be [4x1] (double)');
JaD_transl=NaN(3,1);
if link_index == 0
...
elseif link_index == 3
	...
	t292 = 0.2e1 * t231;
	t294 = -(t259 * t243 + t283) * pkin(2) * t261 - ((-t235 + t277) * pkin(2) * t278 + t280) * t266 + (-0.4e1 * pkin(1) * t273 + (t243 * t264 + (t244 * t226 / 0.2e1 + t243 * t225 / 0.2e1) * t292 + (t259 * t244 - t281) * qJD(1)) * pkin(2)) * t272 + t299 * (t240 * t235 + t229);
	t276 = pkin(1) * t282;
	t271 = 0.2e1 * t276;
	t286 = t231 * t240;
