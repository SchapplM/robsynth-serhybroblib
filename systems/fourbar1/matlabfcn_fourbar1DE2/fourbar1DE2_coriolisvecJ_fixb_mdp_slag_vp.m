...
function tauc = fourbar1DE2_coriolisvecJ_fixb_mdp_slag_vp(qJ, qJD, pkin, MDP)
%% Coder Information
%#codegen
%$cgargs {zeros(1,1),zeros(1,1),zeros(4,1),zeros(9,1)}
assert(isreal(qJ) && all(size(qJ) == [1 1]), ...
  'fourbar1DE2_coriolisvecJ_fixb_mdp_slag_vp: qJ has to be [1x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [1 1]), ...
  'fourbar1DE2_coriolisvecJ_fixb_mdp_slag_vp: qJD has to be [1x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1DE2_coriolisvecJ_fixb_mdp_slag_vp: pkin has to be [4x1] (double)');
assert(isreal(MDP) && all(size(MDP) == [9 1]), ...
  'fourbar1DE2_coriolisvecJ_fixb_mdp_slag_vp: MDP has to be [9x1] (double)'); 

%% Symbolic Calculation
% From coriolisvec_joint_fixb_mdp_matlab.m
% OptimizationMode: 2
% StartTime: 2020-06-26 17:38:31
% EndTime: 2020-06-26 17:38:35
...
t117 = t124 * t216;
t116 = t122 * t216;
t1 = [((((t187 * qJD(1) + t116) * t224 + t164 * (t117 + t187)) * MDP(4) * t121 + ((t188 * qJD(1) + t116) * t224 + t164 * (t117 + t188)) * MDP(7) * t120) * t212 + (((t184 / 0.2e1 - t186 + (t189 / 0.2e1 + t185) * t159) * t127 + 0.2e1 * ((t213 / 0.4e1 + t215 / 0.4e1) * MDP(5) + (t214 / 0.2e1 - t191 / 0.2e1) * MDP(6)) * t124) * t164 + ((-t184 + 0.2e1 * t186 + (-t189 - 0.2e1 * t185) * t159) * t127 * qJD(1) + 0.2e1 * ((-t213 / 0.2e1 - t215 / 0.2e1) * MDP(5) + (t191 - t214) * MDP(6)) * t122) * qJD(1)) * t167 + ((0.2e1 * t227 * t212 + (0.2e1 * t115 * MDP(5) + 0.4e1 * t114 * MDP(6)) * t167 * t127) / t142 + t227 * (t132 / t137 ^ 2 + 0.1e1 / t136 ^ 2 * t134)) * t164 * t228) * t170 / t142 ^ 2;];
tauc = t1;
