...
function JRD_rot = fourbar1DE2_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(1,1),zeros(1,1),uint8(0),zeros(4,1)}
assert(isreal(qJ) && all(size(qJ) == [1 1]), ...
  'fourbar1DE2_jacobiRD_rot_sym_varpar: qJ has to be [1x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [1 1]), ...
  'fourbar1DE2_jacobiRD_rot_sym_varpar: qJD has to be [1x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'fourbar1DE2_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1DE2_jacobiRD_rot_sym_varpar: pkin has to be [4x1] (double)');
JRD_rot=NaN(9,1);
if link_index == 0
...
elseif link_index == 2
	...
	% Computational Cost: add. (1156->50), mult. (1712->93), div. (40->5), fcn. (434->4), ass. (0->58)
	t332 = sin(qJ(1));
	t337 = pkin(1) ^ 2;
	t333 = cos(qJ(1));
	t371 = pkin(2) * t333;
	...
	t363 = t371 * t377 + t337;
	t374 = -pkin(3) - pkin(4);
	t322 = (pkin(2) - t374) * (pkin(2) + t374) + t363;
	t373 = -pkin(3) + pkin(4);
	t323 = (pkin(2) - t373) * (pkin(2) + t373) + t363;
	t375 = pkin(1) * pkin(2);
	t353 = (-t322 - t323) * t375;
	t313 = t332 * t353;
	t312 = qJD(1) * t313;
	...
	t325 = 0.1e1 / t328;
	t362 = qJD(1) * t336;
	t354 = 0.4e1 * t331 * t362;
	t380 = t325 * t337 * t354 * t381 - t333 * t351;
	t383 = -(t345 * qJD(1) + t312 * t369 + t320) * t352 + t380 * (t329 * t338 + t321) - (t313 * t369 + t324 * t371 + t345) * t347;
	t382 = t317 * t313;
	t376 = 0.2e1 * t317;
	t357 = t312 / 0.2e1;
	t311 = (t333 * t353 - 0.4e1 * t337 * t366) * qJD(1);
	t367 = t329 * t311;
	t360 = t332 * t370;
	t364 = -t324 * t360 - t338 * t359;
	t361 = t329 * t377;
	t358 = t325 * t335 / 0.2e1;
	t349 = 0.2e1 * t357;
	t348 = 0.1e1 / t368 * t312 * t382;
	t342 = 0.6e1 * t333 * t332 * pkin(1) * t362 + t329 * t348 + t364;
	t307 = t317 * t312 * t372;
	t306 = (pkin(1) * t354 + t320 + (t332 * t348 + (t333 * t361 - t365) * qJD(1) + (t332 * t311 / 0.2e1 + t349 * t333) * t376) * pkin(2)) * t358 - (t321 + (t333 * t338 + (t361 + t382) * t332) * pkin(2)) * t347 - (t360 * t361 + t307 - t364) * t352 + t380 * (-t324 * t329 + t315);
