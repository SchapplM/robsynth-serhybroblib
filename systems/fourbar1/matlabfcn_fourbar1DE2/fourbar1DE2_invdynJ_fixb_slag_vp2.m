...
function tau = fourbar1DE2_invdynJ_fixb_slag_vp2(qJ, qJD, qJDD, g, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(1,1),zeros(1,1),zeros(1,1),zeros(3,1),zeros(4,1),zeros(4,1),zeros(4,3),zeros(4,6)}
assert(isreal(qJ) && all(size(qJ) == [1 1]), ...
  'fourbar1DE2_invdynJ_fixb_slag_vp2: qJ has to be [1x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [1 1]), ...
  'fourbar1DE2_invdynJ_fixb_slag_vp2: qJD has to be [1x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [1 1]), ...
  'fourbar1DE2_invdynJ_fixb_slag_vp2: qJDD has to be [1x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'fourbar1DE2_invdynJ_fixb_slag_vp2: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'fourbar1DE2_invdynJ_fixb_slag_vp2: pkin has to be [4x1] (double)');
assert(isreal(m) && all(size(m) == [4 1]), ...
  'fourbar1DE2_invdynJ_fixb_slag_vp2: m has to be [4x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [4,3]), ...
  'fourbar1DE2_invdynJ_fixb_slag_vp2: mrSges has to be [4x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [4 6]), ...
  'fourbar1DE2_invdynJ_fixb_slag_vp2: Ifges has to be [4x6] (double)'); 
...
t113 = pkin(1) * t118;
t126 = pkin(1) * t133;
t87 = t65 * t45 * t126 - t113 * t64 + 0.2e1 * t110;
t10 = t13 + t87;
t144 = t29 * t50;
t30 = t29 / t141;
t143 = t30 * t50;
...
t1 = [t10 * t105 / 0.2e1 + Ifges(2,3) * qJDD(1) + (t78 * t177 + t79 * t150 / 0.2e1) * t29 + (t100 * t176 + t3 * t101) * t21 + t171 * Ifges(3,3) * t18 ^ 2 + t2 * t123 * t177 + (-(t145 * t41 - t44 * t49 + t48 * t74) * t117 - (m(3) * t65 + (-t40 * t50 - (-t40 * t44 + t41 * t74) * t51) * t64 * t158) * pkin(2) + mrSges(2,2) * t64 - mrSges(2,1) * t65 - ((t145 * t38 + t45 * t47 + t46 * t74) * t163 + (t39 * t50 - (t38 * t74 + t39 * t45) * t51) * t132) * t68) * g(2) + (-(t145 * t40 + t44 * t48 + t49 * t74) * t117 - (-m(3) + (t41 * t50 - (t40 * t74 + t41 * t44) * t51) * t158) * t157 + mrSges(2,1) * t64 + mrSges(2,2) * t65 - ((t145 * t39 - t45 * t46 + t47 * t74) * t163 + (-t38 * t50 - (-t38 * t45 + t39 * t74) * t51) * t132) * t68) * g(1) + (t100 * t17 + t101 * t16 - t105) * (t12 + t87) + (t102 * t165 + t7 * t98 + t9 * t99 + (-t117 * t168 - t84) * t20 + (t117 * t169 - t173) * t17) * mrSges(3,2) + (-(t165 * t9 + t166 * t6) * t51 / 0.2e1 - (-t16 ^ 2 - t14) * t115 / 0.2e1 + (-t16 * t19 - t147) * t52 * t114 + (t176 * t20 / 0.2e1 + t7 * t165 + t3 * t164 + t5 * t166) * t51 / 0.2e1) * m(3) / t175 + (t171 * t14 + ((-t144 * t9 + t17 * t82) * t165 + (-t144 * t176 + t17 * t81) * t178) * t144 + (t176 * t178 + (t9 / 0.2e1 - t7) * t17) * t123) * Ifges(4,3) + ((t78 * t164 - t16 * t79 / 0.2e1) * t70 + t19 * t84 + t5 * t99 + t6 * t98 + (-t102 / 0.2e1 + t173) * t16) * mrSges(3,1) + (0.3e1 * qJD(1) * t93 - t23 * t122 / 0.2e1 + (t35 * t32 + t34 * t33) * t51 * t114) * (Ifges(4,3) * t147 + t18 * t149);];
tau = t1;
