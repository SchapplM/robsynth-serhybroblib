...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = palh3m2TE_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(18,1)}
assert(isreal(pkin) && all(size(pkin) == [18 1]), ...
  'palh3m2TE_pkin2mdhparam: Kinematic parameters pkin have to be [18x1] (double)');
