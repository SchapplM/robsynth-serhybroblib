...
function tauc_reg = palh3m2TE_coriolisvecJ_fixb_reg2_slag_vp(qJ, qJD, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(4,1),zeros(18,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh3m2TE_coriolisvecJ_fixb_reg2_slag_vp: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'palh3m2TE_coriolisvecJ_fixb_reg2_slag_vp: qJD has to be [4x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [18 1]), ...
  'palh3m2TE_coriolisvecJ_fixb_reg2_slag_vp: pkin has to be [18x1] (double)');

%% Symbolic Calculation
% From coriolisvec_joint_fixb_regressor_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-07 01:48:14
% EndTime: 2020-05-07 01:48:18
...
t971 = 2 * qJD(1);
t975 = qJD(4) * t706 + (t845 * t971 - qJD(4)) * t698;
t924 = t809 * t810;
t774 = pkin(4) * t924;
t763 = t774 + pkin(12);
t821 = pkin(4) ^ 2;
...
t915 = t816 * t811;
t887 = pkin(10) * t915;
t742 = t782 * pkin(8) - t887;
t743 = pkin(8) * t915 + t782 * pkin(10);
t771 = -t915 / 0.2e1;
t791 = t804 ^ 2;
t928 = t803 * t804;
t962 = 0.1e1 / 0.4e1 - t800 / 0.2e1;
t943 = (pkin(8) * t771 + pkin(10) * t962 + t742 * t928 + t743 * t791) * t785;
t965 = t654 * qJD(2) + t664 * t947 + t866 - (t939 + 0.4e1 * t943) * t820;
t922 = t810 * t815;
t892 = -0.2e1 * t922;
t753 = t814 * t809 * t892;
t798 = t814 ^ 2;
...
t903 = qJD(1) * t808;
t738 = t749 * t947;
t829 = qJD(2) * t934 - t792 * t774 + t814 * t880;
t961 = (-t861 * qJD(2) + t738 + t829) * qJD(1);
t960 = t829 * qJD(2) - t947 * t969;
t667 = t669 * qJD(2);
t655 = -t810 * t689 + t690 * t815 + t667;
t665 = qJD(2) * t847 + t694 * t810 - t695 * t815;
t780 = t786 ^ 2;
t853 = t742 * t791 - t743 * t928;
t944 = (t887 / 0.2e1 + t962 * pkin(8) + t853) * t780;
t958 = 0.4e1 * t820 * t944 + t725 * t893 + (t725 * t744 * t820 - t655 * qJD(2) + t665 * t947) * t785;
t956 = -0.2e1 * t820;
t954 = 4 * qJD(1);
t953 = -t706 / 0.2e1;
t952 = pkin(1) * t809;
...
t702 = t842 * qJD(2);
t801 = t817 ^ 2;
t831 = (-t782 * t812 * t817 + t801 * t915 + t771) * t892 - t906 * (t782 * t801 + t914 * t920 + t962);
t827 = -t872 + pkin(12) * t886 + (-pkin(4) * t929 + t763 * t810) * t779;
t826 = t961 + ((t654 - t879 - t897) * t786 + (-t655 + t667 - t976) * t785) * qJD(4);
t825 = -0.2e1 * qJD(2) * t872 + t768 * t973 + 0.2e1 * (-t730 * t815 + t763 * t901) * t779 + t974 * qJD(3);
t824 = -t974 * t820 / 0.2e1 + (t779 * t814 * t870 - t819 * t952) * pkin(4);
t823 = (t725 + t846) * t818 + (-0.8e1 * t944 + (0.2e1 * t939 + 0.8e1 * t943) * t786 - 0.2e1 * t725 * t933 + 0.4e1 * t680) * t893 + t960;
t790 = t792 ^ 2;
t755 = t788 * t930;
t754 = t776 * t890;
