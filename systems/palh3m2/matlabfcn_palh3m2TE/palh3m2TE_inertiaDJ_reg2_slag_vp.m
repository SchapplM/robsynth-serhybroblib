...
function MMD_reg = palh3m2TE_inertiaDJ_reg2_slag_vp(qJ, qJD, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(4,1),zeros(18,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh3m2TE_inertiaDJ_reg2_slag_vp: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'palh3m2TE_inertiaDJ_reg2_slag_vp: qJD has to be [4x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [18 1]), ...
  'palh3m2TE_inertiaDJ_reg2_slag_vp: pkin has to be [18x1] (double)');

%% Symbolic Calculation
% From inertiaD_joint_joint_fixb_regressor_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-07 01:48:13
% EndTime: 2020-05-07 01:48:14
...
t613 = -0.8e1 * qJD(4) * ((t555 * t631 + (t562 - 0.1e1 / 0.2e1) * t626) * t554 - (-t555 * t562 + t626 * t631 - t612) * t556 * t557 - t562 * t626 / 0.2e1 + t612 * t631 + t626 / 0.4e1);
t611 = 0.2e1 * t636 - 0.2e1 * t615 - pkin(8);
t610 = pkin(1) * t623;
t609 = pkin(1) * t622;
t552 = pkin(1) * t621;
t517 = pkin(12) + t520;
t608 = t559 * t632;
t607 = (t555 * pkin(10) + t616) * t631;
t603 = t579 * t622;
t602 = -0.2e1 * t610;
t601 = 0.2e1 * t610;
