...
function Ja_transl = palh3m2TE_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh3m2TE_jacobia_transl_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'palh3m2TE_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh3m2TE_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [18 1]), ...
  'palh3m2TE_jacobia_transl_sym_varpar: pkin has to be [18x1] (double)');
Ja_transl=NaN(3,4);
if link_index == 0
...
elseif link_index == 5
	...
	t32 = cos(qJ(1));
	t35 = t37 * t32;
	t13 = t28 * pkin(8) + t33 * pkin(10);
	t14 = t33 * pkin(8) - t28 * pkin(10);
	t5 = t11 * t20 + t12 * t19;
	t34 = r_i_i_C(3) * t5 + t19 * (t13 * t23 + t22 * t14) - t20 * (-t22 * t13 + t14 * t23) + pkin(12) + t38;
	t29 = cos(qJ(4));
	t24 = sin(qJ(4));
	t17 = t25 * t39;
	t10 = t26 * t40 + t17;
	...
	t2 = t32 * t24 + t29 * t36;
	t1 = t24 * t36 - t32 * t29;
	t6 = [t2 * r_i_i_C(1) - t1 * r_i_i_C(2) - t34 * t27, t9 * t32, t10 * t32, t3 * r_i_i_C(1) + t4 * r_i_i_C(2); -t4 * r_i_i_C(1) + t3 * r_i_i_C(2) + t34 * t32, t9 * t27, t10 * t27, t1 * r_i_i_C(1) + t2 * r_i_i_C(2); 0, t38, -t30 * t39 + t16, (-r_i_i_C(1) * t24 - r_i_i_C(2) * t29) * t5;];
	Ja_transl = t6;
elseif link_index == 6
	%% Symbolic Calculation
