...
function JR_rot = palh3m2DE1_jacobiR_rot_sym_varpar(qJ, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),uint8(0),zeros(18,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh3m2DE1_jacobiR_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh3m2DE1_jacobiR_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [18 1]), ...
  'palh3m2DE1_jacobiR_rot_sym_varpar: pkin has to be [18x1] (double)');
JR_rot=NaN(9,4);
if link_index == 0
...
elseif link_index == 4
	...
	t30 = t33 * t31 - t32 * t34;
	t29 = t31 * t34 + t32 * t33;
	t1 = [-t30 * t38, 0, 0, 0; t30 * t40, 0, 0, 0; 0, 0, 0, 0; t29 * t38, 0, 0, 0; -t29 * t40, 0, 0, 0; 0, 0, 0, 0; t40, 0, 0, 0; t38, 0, 0, 0; 0, 0, 0, 0;];
	JR_rot = t1;
elseif link_index == 5
	%% Symbolic Calculation
	...
	t108 = sin(pkin(15));
	t111 = cos(pkin(15));
	t100 = -t104 * t108 + t105 * t111;
	t103 = pkin(17) + pkin(18);
	t101 = sin(t103);
	t102 = cos(t103);
	t99 = t104 * t111 + t105 * t108;
	t97 = t100 * t101 + t99 * t102;
	t114 = t100 * t102 - t101 * t99;
	t107 = sin(qJ(1));
	t113 = t114 * t107;
	t110 = cos(qJ(1));
	t112 = t114 * t110;
	t109 = cos(qJ(4));
	t106 = sin(qJ(4));
	t96 = -t107 * t106 + t109 * t112;
	t95 = t106 * t112 + t107 * t109;
	t94 = t110 * t106 + t109 * t113;
	t93 = t106 * t113 - t110 * t109;
	t1 = [t94, 0, 0, t95; -t96, 0, 0, t93; 0, 0, 0, -t97 * t106; -t93, 0, 0, t96; t95, 0, 0, t94; 0, 0, 0, -t97 * t109; -t97 * t107, 0, 0, 0; t97 * t110, 0, 0, 0; 0, 0, 0, 0;];
	JR_rot = t1;
elseif link_index == 6
	%% Symbolic Calculation
