...
function JRD_rot = palh3m2DE1_jacobiRD_rot_sym_varpar(qJ, qJD, link_index, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(4,1),uint8(0),zeros(18,1)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh3m2DE1_jacobiRD_rot_sym_varpar: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'palh3m2DE1_jacobiRD_rot_sym_varpar: qJD has to be [4x1] (double)');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh3m2DE1_jacobiRD_rot_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [18 1]), ...
  'palh3m2DE1_jacobiRD_rot_sym_varpar: pkin has to be [18x1] (double)');
JRD_rot=NaN(9,4);
if link_index == 0
...
elseif link_index == 5
	...
	t283 = sin(pkin(15));
	t286 = cos(pkin(15));
	t274 = t279 * t286 + t280 * t283;
	t275 = -t279 * t283 + t280 * t286;
	t278 = pkin(17) + pkin(18);
	t276 = sin(t278);
	t277 = cos(t278);
	t272 = t274 * t277 + t275 * t276;
	t296 = qJD(4) * t272;
	t281 = sin(qJ(4));
	t282 = sin(qJ(1));
	t295 = t281 * t282;
	...
	t294 = t282 * t284;
	t293 = qJD(1) * t272;
	t292 = t274 * t276 - t275 * t277;
	t285 = cos(qJ(1));
	t291 = t292 * t285;
	t290 = -t284 * t291 - t295;
	t289 = t281 * t285 - t292 * t294;
	t288 = -t281 * t291 + t294;
	t287 = t284 * t285 + t292 * t295;
	t271 = t290 * qJD(1) + t287 * qJD(4);
	t270 = t288 * qJD(1) + t289 * qJD(4);
	t269 = t289 * qJD(1) + t288 * qJD(4);
	t268 = t287 * qJD(1) + t290 * qJD(4);
	t1 = [t271, 0, 0, t268; t269, 0, 0, t270; 0, 0, 0, -t284 * t296; -t270, 0, 0, -t269; t268, 0, 0, t271; 0, 0, 0, t281 * t296; -t285 * t293, 0, 0, 0; -t282 * t293, 0, 0, 0; 0, 0, 0, 0;];
	JRD_rot = t1;
elseif link_index == 6
	%% Symbolic Calculation
