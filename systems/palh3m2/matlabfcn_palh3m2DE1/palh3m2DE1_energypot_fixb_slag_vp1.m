...
function U = palh3m2DE1_energypot_fixb_slag_vp1(qJ, g, ...
  pkin, m, rSges)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(3,1),zeros(18,1),zeros(9,1),zeros(9,3)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh3m2DE1_energypot_fixb_slag_vp1: qJ has to be [4x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'palh3m2DE1_energypot_fixb_slag_vp1: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [18 1]), ...
  'palh3m2DE1_energypot_fixb_slag_vp1: pkin has to be [18x1] (double)');
assert(isreal(m) && all(size(m) == [9 1]), ...
  'palh3m2DE1_energypot_fixb_slag_vp1: m has to be [9x1] (double)'); 
assert(isreal(rSges) && all(size(rSges) == [9,3]), ...
  'palh3m2DE1_energypot_fixb_slag_vp1: rSges has to be [9x3] (double)');
...
t1 = (-t61 * g(3) + t109 * t62) * cos(t81) + (-t62 * g(3) - t109 * t61) * sin(t81) + (t102 * g(1) + t115 * g(2)) * t98 + (-t115 * g(1) + t102 * g(2)) * t92 + t64 * g(3) * t97 - t63 * g(3) * t91 - m(6) * pkin(11) * g(3) - g(3) * ((m(2) + m(7) - t110) * pkin(11) + m(2) * rSges(2,3) + pkin(13) * m(7)) - m(8) * (g(1) * (t92 * rSges(8,3) + t66 * t98) + g(2) * (-t98 * rSges(8,3) + t66 * t92) + g(3) * ((t85 * rSges(8,1) - rSges(8,2) * t87) * t99 + t93 * (rSges(8,1) * t87 + rSges(8,2) * t85) + t112)) - m(9) * ((-g(2) * rSges(9,3) + g(1) * t104) * t98 + (g(1) * rSges(9,3) + g(2) * t104) * t92 + (-t77 * rSges(9,1) - t78 * rSges(9,2) + t112 + (t105 * t86 + t106 * t88) * pkin(3)) * g(3)) + (-rSges(1,1) * g(1) - rSges(1,2) * g(2) - rSges(1,3) * g(3)) * m(1);
U = t1;
