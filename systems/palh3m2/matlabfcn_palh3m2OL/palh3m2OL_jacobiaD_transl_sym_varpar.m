...
function JaD_transl = palh3m2OL_jacobiaD_transl_sym_varpar(qJ, qJD, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [10 1]), ...
  'palh3m2OL_jacobiaD_transl_sym_varpar: qJ has to be [10x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [10 1]), ...
  'palh3m2OL_jacobiaD_transl_sym_varpar: qJD has to be [10x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'palh3m2OL_jacobiaD_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh3m2OL_jacobiaD_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [16 1]), ...
  'palh3m2OL_jacobiaD_transl_sym_varpar: pkin has to be [16x1] (double)');
JaD_transl=NaN(3,10);
if link_index == 0
...
elseif link_index == 3
	...
	t57 = r_i_i_C(2) * t64;
	t55 = qJD(1) * t66;
	t53 = -pkin(1) * t50 + r_i_i_C(1) * t45 - r_i_i_C(2) * t44 - pkin(12);
	t52 = t51 * t55 + t60 * t65 + (-t57 + t58) * t49;
	t38 = t51 * t58;
	t1 = [-t68 * t49 + (-r_i_i_C(3) * t49 + t53 * t51) * qJD(1), t38 + (-pkin(1) * t59 - t57) * t51 + (-t54 + t67) * t61, -t49 * t55 + t38 + (-t45 * t61 - t51 * t64) * r_i_i_C(2), 0, 0, 0, 0, 0, 0, 0; t68 * t51 + (r_i_i_C(3) * t51 + t53 * t49) * qJD(1), (-t48 * t60 - t49 * t59) * pkin(1) + t52, t52, 0, 0, 0, 0, 0, 0, 0; 0, -t56 + t62, t62, 0, 0, 0, 0, 0, 0, 0;];
	JaD_transl = t1;
elseif link_index == 4
	%% Symbolic Calculation
...
elseif link_index == 7
	...
	t49 = t36 * t56;
	t48 = qJD(1) * t55;
	t45 = -pkin(1) * t40 - r_i_i_C(1) * t35 - pkin(12) + t56;
