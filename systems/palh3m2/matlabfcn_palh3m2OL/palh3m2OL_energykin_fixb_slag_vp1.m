...
function T = palh3m2OL_energykin_fixb_slag_vp1(qJ, qJD, ...
  pkin, m, rSges, Icges)
%% Coder Information
%#codegen
%$cgargs {zeros(10,1),zeros(10,1),zeros(16,1),zeros(9,1),zeros(9,3),zeros(9,6)}
assert(isreal(qJ) && all(size(qJ) == [10 1]), ...
  'palh3m2OL_energykin_fixb_slag_vp1: qJ has to be [10x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [10 1]), ...
  'palh3m2OL_energykin_fixb_slag_vp1: qJD has to be [10x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [16 1]), ...
  'palh3m2OL_energykin_fixb_slag_vp1: pkin has to be [16x1] (double)');
assert(isreal(m) && all(size(m) == [9 1]), ...
  'palh3m2OL_energykin_fixb_slag_vp1: m has to be [9x1] (double)'); 
assert(isreal(rSges) && all(size(rSges) == [9,3]), ...
  'palh3m2OL_energykin_fixb_slag_vp1: rSges has to be [9x3] (double)');
assert(isreal(Icges) && all(size(Icges) == [9 6]), ...
  'palh3m2OL_energykin_fixb_slag_vp1: Icges has to be [9x6] (double)'); 

%% Symbolic Calculation
% From energy_kinetic_fixb_worldframe_par1_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-07 04:33:30
% EndTime: 2020-05-07 04:33:35
...
t1 = t419 * ((-t384 * t597 + t467 * t386 + t468 * t388) * t419 + (-t383 * t597 + t385 * t467 + t387 * t468) * t420 + (-t398 * t597 + t399 * t467 + t400 * t468) * t496) / 0.2e1 + t420 * ((-t384 * t598 + t386 * t465 + t388 * t466) * t419 + (-t383 * t598 + t465 * t385 + t466 * t387) * t420 + (-t398 * t598 + t399 * t465 + t400 * t466) * t496) / 0.2e1 + t496 * ((t383 * t420 + t384 * t419 + t398 * t496) * t512 + ((t386 * t529 - t388 * t533) * t419 + (t385 * t529 - t387 * t533) * t420 + (t399 * t529 - t400 * t533) * t496) * t511) / 0.2e1 + t493 * (t542 * t531 + t537 * t535) / 0.2e1 + t495 * (t537 * t531 - t542 * t535) / 0.2e1 + t492 * (t543 * t531 + t538 * t535) / 0.2e1 + t494 * (t538 * t531 - t543 * t535) / 0.2e1 + t477 * (t544 * t531 + t539 * t535) / 0.2e1 + t479 * (t539 * t531 - t544 * t535) / 0.2e1 + t476 * (t545 * t531 + t540 * t535) / 0.2e1 + t478 * (t540 * t531 - t545 * t535) / 0.2e1 - ((-t535 * t497 + t531 * t550) * qJD(1) + (t617 * t443 + (t553 * t531 + (-t444 + t554) * t535) * t531) * qJD(6)) * t586 / 0.2e1 - ((-t535 * t498 + t531 * t549) * qJD(1) + (t617 * t445 + (t551 * t531 + (-t446 + t552) * t535) * t531) * qJD(2)) * t589 / 0.2e1 + ((t531 * t497 + t535 * t550) * qJD(1) + (t618 * t444 + (t554 * t535 + (-t443 + t553) * t531) * t535) * qJD(6)) * t587 / 0.2e1 + ((t531 * t498 + t535 * t549) * qJD(1) + (t618 * t446 + (t552 * t535 + (-t445 + t551) * t531) * t535) * qJD(2)) * t518 / 0.2e1 + m(6) * (t368 ^ 2 + t369 ^ 2 + t370 ^ 2) / 0.2e1 + m(3) * (t392 ^ 2 + t393 ^ 2 + t395 ^ 2) / 0.2e1 + m(7) * (t391 ^ 2 + t394 ^ 2 + t396 ^ 2) / 0.2e1 + m(9) * (t371 ^ 2 + t373 ^ 2 + t374 ^ 2) / 0.2e1 + m(5) * (t372 ^ 2 + t375 ^ 2 + t376 ^ 2) / 0.2e1 + m(8) * (t377 ^ 2 + t379 ^ 2 + t381 ^ 2) / 0.2e1 + m(4) * (t378 ^ 2 + t380 ^ 2 + t382 ^ 2) / 0.2e1 + (Icges(2,3) + m(2) * (t505 ^ 2 + t506 ^ 2)) * qJD(1) ^ 2 / 0.2e1 + (((t450 * t534 + t454 * t530) * t531 - (t449 * t534 + t453 * t530) * t535) * qJD(2) + ((t448 * t532 + t452 * t528) * t531 - (t447 * t532 + t451 * t528) * t535) * qJD(6) + (-t432 * t522 - t436 * t520) * t493 + (-t431 * t522 - t435 * t520) * t495 + (t430 * t521 + t434 * t519) * t492 + (t429 * t521 + t433 * t519) * t494 + (-t416 * t512 - t418 * t511) * t477 + (-t415 * t512 - t417 * t511) * t479 + (-t404 * t508 + t406 * t507) * t476 + (-t403 * t508 + t405 * t507) * t478 + (-t508 * t462 + t507 * t463 - t512 * t472 - t511 * t473 + t521 * t484 - t522 * t485 + t519 * t486 - t520 * t487 + t499 * t532 + t500 * t534 + t501 * t528 + t530 * t502) * qJD(1)) * qJD(1) / 0.2e1;
T = t1;
