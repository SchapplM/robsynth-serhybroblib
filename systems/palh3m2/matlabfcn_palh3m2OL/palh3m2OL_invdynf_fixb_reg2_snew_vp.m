...
function f_new_reg = palh3m2OL_invdynf_fixb_reg2_snew_vp(qJ, qJD, qJDD, g, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(10,1),zeros(10,1),zeros(10,1),zeros(3,1),zeros(16,1)}
assert(isreal(qJ) && all(size(qJ) == [10 1]), ...
  'palh3m2OL_invdynf_fixb_reg2_snew_vp: qJ has to be [10x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [10 1]), ...
  'palh3m2OL_invdynf_fixb_reg2_snew_vp: qJD has to be [10x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [10 1]), ...
  'palh3m2OL_invdynf_fixb_reg2_snew_vp: qJDD has to be [10x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'palh3m2OL_invdynf_fixb_reg2_snew_vp: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [16 1]), ...
  'palh3m2OL_invdynf_fixb_reg2_snew_vp: pkin has to be [16x1] (double)');

%% Symbolic Calculation
% From invdyn_fixb_NewtonEuler_f_regressor_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-07 04:44:38
% EndTime: 2020-05-07 04:44:49
...
t2245 = -t2522 * pkin(8) + pkin(10) * t2496 - t2364 * t2319 + t2273;
t2244 = -pkin(8) * t2496 - t2522 * pkin(10) + t2366 * t2319 - t2272;
...
t2231 = pkin(8) * t2274 + pkin(10) * t2495 - t2312;
