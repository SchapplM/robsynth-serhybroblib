...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = palh3m2OL_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(16,1)}
assert(isreal(pkin) && all(size(pkin) == [16 1]), ...
  'palh3m2OL_pkin2mdhparam: Kinematic parameters pkin have to be [16x1] (double)');

%% Zuweisung der Parameter


% Aus parameters_mdh_beta_matlab.m
t1 = [0; 0; 0; 0; 0; 0; 0; -pkin(15); pkin(16); pkin(14); 0; pi;];
beta_mdh = t1;
