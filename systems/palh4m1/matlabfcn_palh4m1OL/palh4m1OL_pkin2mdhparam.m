...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = palh4m1OL_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(7,1)}
assert(isreal(pkin) && all(size(pkin) == [7 1]), ...
  'palh4m1OL_pkin2mdhparam: Kinematic parameters pkin have to be [7x1] (double)');
...
t1 = [0; -pkin(7); 0; 0; pkin(3); 0; pkin(6); pkin(2); pkin(1);];
a_mdh = t1;
...
t1 = [pkin(5); 0; 0; 0; 0; pkin(4); 0; 0; 0;];
d_mdh = t1;
