...
function T = picker2Dm2DE1_energykin_fixb_slag_vp2(qJ, qJD, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(2,1),zeros(2,1),zeros(9,1),zeros(11,1),zeros(11,3),zeros(11,6)}
assert(isreal(qJ) && all(size(qJ) == [2 1]), ...
  'picker2Dm2DE1_energykin_fixb_slag_vp2: qJ has to be [2x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [2 1]), ...
  'picker2Dm2DE1_energykin_fixb_slag_vp2: qJD has to be [2x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [9 1]), ...
  'picker2Dm2DE1_energykin_fixb_slag_vp2: pkin has to be [9x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm2DE1_energykin_fixb_slag_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'picker2Dm2DE1_energykin_fixb_slag_vp2: mrSges has to be [11x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [11 6]), ...
  'picker2Dm2DE1_energykin_fixb_slag_vp2: Ifges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From energy_kinetic_fixb_linkframe_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-09 14:29:07
% EndTime: 2020-05-09 14:29:35
...
t1173 = t803 * t892;
t1197 = pkin(7) * t925;
t1179 = ((0.8e1 * t1034 - 0.4e1 * t1173) * t970 + (t864 * t1203 + t1085) * t1119 + (0.2e1 * t927 ^ 2 * t1118 * t1197 + (-t1078 * t928 + t791 * t1123) * t859 + (t824 * t1062 + (-t791 * t1157 - t824 * t1160) * qJD(2)) * pkin(3)) * t1113) / t973;
t1058 = t1179 / 0.2e1;
t1122 = qJD(1) * t927;
t1124 = 0.2e1 * pkin(7);
t1156 = t928 * t973;
...
t1187 = pkin(1) * t892;
t1196 = pkin(7) * t928;
t703 = t795 * t1058 + (-t859 * t1158 + t750 * t928) * qJD(1) + (-t815 * t1123 + t803 * t928) * t925 * t1114 + ((-t1156 + (-t823 - 0.8e1 * t1099) * t925) * t1122 + ((-t754 + t1158) * t924 + (t1156 + (t859 * t1124 + t823) * t925 + (-pkin(1) + t1196 + 0.2e1 * t1187) * t927 * t1221) * t927) * qJD(2)) * pkin(3);
...
t994 = 0.4e1 * t998;
t992 = t994 * t879;
t704 = t797 * t1058 + (-t853 * t928 + (t787 * t925 + t1156) * qJD(1)) * t859 + (t1022 + 0.4e1 * t1034 - 0.2e1 * t1173) * pkin(1) + ((t855 * t928 - t1158) * t1122 + (-t1012 * t973 - t787 * t1157 - t855 * t1160) * qJD(2) + (t841 * t1119 + t998 * t877) * t1124 + t859 * t992) * pkin(3);
...
t854 = -0.2e1 * t1046;
t889 = t925 ^ 2;
t1182 = ((t860 * t1041 * t1202 + t889 * t1068 * t1217 + t1005 * t1186 + (0.2e1 * (-t970 * t1088 - t974 * t1121) * t892 + t825 * t1043 - t884 * t1088 + (t881 * t1121 + (-t925 * t1122 - t1063) * pkin(7) * t1221) * pkin(1)) * t1104 - 0.8e1 * t748 * t1030 - 0.4e1 * (-t1038 + (0.4e1 * t927 * t1029 + (-t867 + 0.2e1 * t1150) * t1120) * pkin(3) + ((-t1088 - t1089) * t879 - t835 * t1090) * t1124) * t1098 + t1019 * t1207 + t1009 * t878 + (t1032 * t1199 - t858 * t1120) * t892 + t788 * t1043 - 0.4e1 * (-t867 * t1088 - t1038) * t1110 + 0.4e1 * t786 * t1046 + t811 * t1088 + t821 * t1089 + 0.4e1 * t1211 * t745) * t973 + t722 * t1058 + (0.8e1 * (t854 - 0.8e1 * t1029) * t1081 + (-0.12e2 * t1023 + 0.6e1 * (-0.4e1 / 0.9e1 * t1062 + 0.4e1 / 0.9e1 * t1064) * t1049 - 0.12e2 * t794 * t1029 - t776 - 0.4e1 * t805 * t1046 - 0.2e1 * t1008 + 0.2e1 * t1007) * t1093 + 0.24e2 * t733 * t1030 + 0.6e1 * (t863 * t1043 + (-t799 * t1123 + t1142 * t928) * pkin(7) * t1113 + t1144) * t1098 + t770 * t1018 + t1144 * t1083 + t746 * t1036 + t1146 + (-0.8e1 * t1021 + 0.24e2 * t1015) * t816 + t1224 * t771 - 0.6e1 * t1211 * t735) * t827 + t717 * t822) / t1222;
t1131 = t959 - t978;
...
t1039 = pkin(3) * t1063;
t1033 = t968 * t1067;
t1031 = t887 * t978 * t1119;
t1028 = t673 + t1225;
t1020 = t1088 * t1164;
t1010 = -0.48e2 * t1023;
t993 = t998 * t1114;
t995 = -t762 * t1088 - t780 * t1089;
t665 = (t1042 * t1089 - 0.24e2 * pkin(1) * (-0.8e1 / 0.3e1 * t1029 + t854) * t1080 - 0.96e2 * t806 * t1031 * t1186 + ((-t885 + t1101) * t1088 + 0.2e1 * (pkin(1) * t848 - t826 * t925 - 0.2e1 * t1161) * t1121 + (-0.2e1 * t1039 + (-0.2e1 * t834 * t925 + 0.4e1 * t1187) * qJD(1)) * pkin(1) * pkin(7)) * t1045 + (0.8e1 / 0.3e1 * t1020 + (-t839 * t1088 - t836 * t1089) * t1100 - t775 * t1088 + t1089 * t1193 + (0.32e2 / 0.3e1 * t1163 * t878 + t970 * t769 * t1202) * t1123 + (t846 * t1039 * t1206 + ((0.12e2 * t889 * t892 - 0.4e1 * t890) * t968 + (-0.2e1 * t869 * t1187 - 0.4e1 * t781 * t925) * pkin(1)) * qJD(1)) * pkin(7)) * t1094 - 0.24e2 * t725 * t1030 - 0.6e1 * ((-0.4e1 * (pkin(1) * t1032 - 0.2e1 * t850 * t1088) * t892 + 0.8e1 * t785 * t1066) * t970 + (0.8e1 * t1019 + (-t845 * t1088 - t843 * t1089) * t1108 + (0.24e2 * t892 * t1095 + t773 * t1206) * t1123) * pkin(7) + t995) * t1098 + (t1086 * t1121 - t837 * t1088) * t1051 + t783 * t1010 + (-t778 * t1088 + t1089 * t1219) * t1102 + 0.12e2 * t738 * t1029 - 0.6e1 * t995 * t1110 + 0.6e1 * t737 * t1046 + t739 * t1088 + t747 * t1089 + (-0.96e2 * t1033 * t878 - 0.24e2 * t1020) * t873 + (0.8e1 * t1021 + t1005) * t741 + 0.6e1 * t1211 * t728) * t973 + t709 * t1058 + (0.16e2 * (t872 * t1201 - 0.48e2 * t1106 - 0.32e2 * t1163 - t865) * qJD(1) * t1080 + 0.64e2 * t756 * t1031 + 0.32e2 * (-t776 + (t792 * t1201 + (t798 * t1206 - 0.24e2 * t1161) * pkin(7)) * t1123 + (-t993 * t1154 - t994 * t1161) * pkin(3)) * t1081 + 0.24e2 * (-0.32e2 * t874 * t1033 + (-0.2e1 / 0.3e1 * t1062 + 0.2e1 / 0.3e1 * t1064) * t1051 * t1198 + t804 * t1010 - 0.28e2 * t742 * t1029 + (-0.8e1 / 0.3e1 * t1062 + 0.8e1 / 0.3e1 * t1064) * t840 * pkin(3) * t970 * t1115 + t744 * t1036 + 0.4e1 * (-t1008 + t1007) * t849 - 0.64e2 / 0.3e1 * t998 * t838 * t1049) * t1165 + 0.48e2 * t723 * t1030 - 0.8e1 * t724 * t1026 + 0.8e1 * (t772 * t1018 + (-pkin(3) * t849 * t992 - t749 * t1123) * pkin(7) * t1112 + t1146 + t1147) * t1098 + t1040 * t1220 - 0.4e1 * t833 * t1067 - pkin(3) * t993 * t1050 * t1155 - 0.96e2 * t774 * t1023 - 0.96e2 * t849 * t991 - 0.48e2 * t736 * t1029 + 0.8e1 * t1147 * t1110 - 0.8e1 * t732 * t1046 + 0.8e1 * t1223 * t740 + (-0.32e2 * t1021 + 0.96e2 * t1015) * t734) * t827 + t702 * t822;
...
t1 = qJD(2) ^ 2 * Ifges(8,3) / 0.2e1 + m(11) * (t639 ^ 2 + t640 ^ 2) / 0.2e1 + m(5) * (t656 ^ 2 + t657 ^ 2) / 0.2e1 + m(4) * (t658 ^ 2 + t659 ^ 2) / 0.2e1 + t726 ^ 2 * Ifges(9,3) / 0.2e1 + t727 ^ 2 * Ifges(6,3) / 0.2e1 + m(10) * (t641 ^ 2 + t642 ^ 2) / 0.2e1 + m(7) * (t668 ^ 2 + t669 ^ 2) / 0.2e1 + t673 ^ 2 * Ifges(3,3) / 0.2e1 + (t656 * mrSges(5,1) - t657 * mrSges(5,2) + Ifges(5,3) * t646 / 0.2e1) * t646 + (t641 * mrSges(10,1) - t642 * mrSges(10,2) + Ifges(10,3) * t643 / 0.2e1) * t643 + (t639 * mrSges(11,1) - t640 * mrSges(11,2) + Ifges(11,3) * t638 / 0.2e1) * t638 + ((-mrSges(9,1) * t761 + mrSges(9,2) * t760) * t726 + (mrSges(3,1) * t714 - mrSges(3,2) * t713) * t673) * t1185 + (Ifges(2,3) / 0.2e1 + (m(3) * (t713 ^ 2 + t714 ^ 2) / 0.2e1 + m(9) * (t760 ^ 2 + t761 ^ 2) / 0.2e1) * t970) * qJD(1) ^ 2 + (t658 * mrSges(4,1) + t668 * mrSges(7,1) - t659 * mrSges(4,2) - t669 * mrSges(7,2) + (Ifges(7,3) / 0.2e1 + Ifges(4,3) / 0.2e1) * t648) * t648;
T = t1;
