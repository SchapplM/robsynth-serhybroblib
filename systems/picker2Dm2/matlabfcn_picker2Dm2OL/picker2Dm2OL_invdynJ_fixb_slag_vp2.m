...
function tau = picker2Dm2OL_invdynJ_fixb_slag_vp2(qJ, qJD, qJDD, g, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
...
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm2OL_invdynJ_fixb_slag_vp2: qJ has to be [12x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [12 1]), ...
  'picker2Dm2OL_invdynJ_fixb_slag_vp2: qJD has to be [12x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [12 1]), ...
  'picker2Dm2OL_invdynJ_fixb_slag_vp2: qJDD has to be [12x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'picker2Dm2OL_invdynJ_fixb_slag_vp2: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm2OL_invdynJ_fixb_slag_vp2: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm2OL_invdynJ_fixb_slag_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'picker2Dm2OL_invdynJ_fixb_slag_vp2: mrSges has to be [11x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [11 6]), ...
  'picker2Dm2OL_invdynJ_fixb_slag_vp2: Ifges has to be [11x6] (double)'); 
...
t240 = g(1) * t106;
t239 = g(1) * t126;
t234 = mrSges(5,1) * t144;
t117 = qJD(9) + t145;
t233 = mrSges(10,1) * t117;
t232 = t164 * t54;
t230 = t166 * t55;
t140 = qJDD(6) + t158;
...
t1 = [t196 + (-m(4) * (t123 + t155) - m(5) * t218 - m(11) * (t105 + t218) - m(10) * (t155 + t202) - mrSges(2,2) * t181 - t173 * mrSges(2,1) - t194 + t250) * g(1) + t184 + (mrSges(2,1) * t181 - t173 * mrSges(2,2) - t199 + t249) * g(2) + m(5) * (t16 * t74 + t17 * t71 + t54 * t43 + t52 * t44) + m(4) * (t18 * t75 + t19 * t72 - t55 * t45 + t53 * t46) + m(7) * (-t29 * t83 + t30 * t82 - t47 * t64 + t48 * t61) + m(10) * (t10 * t22 - t192 * t5 - t23 * t9 + t37 * t6) + m(11) * (-t193 * t3 + t20 * t8 - t21 * t7 + t33 * t4) + (t83 * t140 - t47 * t143 - t29) * mrSges(7,2) + (-t75 * t142 - t45 * t145 - t18) * mrSges(4,2) + (t108 * t193 - t116 * t7 - t3) * mrSges(11,2) + (t82 * t140 + t48 * t143) * mrSges(7,1) + (t72 * t142 + t46 * t145) * mrSges(4,1) + (t10 * t117 + t37 * t114) * mrSges(10,1) + (t71 * t141 + t44 * t144) * mrSges(5,1) + (t33 * t108 + t8 * t116) * mrSges(11,1) + (t114 * t192 - t9 * t117 - t5) * mrSges(10,2) + (-t74 * t141 - t43 * t144 - t16) * mrSges(5,2) + Ifges(2,3) * qJDD(1) + (t209 * t173 * g(1) + (-t209 + t243 + t244) * t181 * g(2) + (t157 * t167 + t175 * t212) * mrSges(9,2) + (-t158 * t172 - t160 * t217) * mrSges(3,2) + (-t157 * t175 + t167 * t212) * mrSges(9,1) + (-qJD(2) * t160 * t172 + t158 * t180) * mrSges(3,1) + m(9) * (-t167 * t85 - t175 * t84) + m(3) * (t172 * t87 + t180 * t86)) * pkin(1); ((-t122 - t105) * g(1) + t3 * t68 + t4 * t67 + t254 * t21 + t255 * t20) * m(11) + (-t202 * g(1) + t253 * t22 + t252 * t23 + t5 * t73 + t6 * t70) * m(10) - t62 * t234 + ((t142 * t171 + t145 * t215) * mrSges(4,2) + (-t142 * t179 + t145 * t216) * mrSges(4,1)) * pkin(2) + ((-t141 * t170 - t144 * t213) * mrSges(5,2) + (t141 * t178 - t144 * t214) * mrSges(5,1)) * pkin(3) + t248 + (mrSges(3,1) * t172 + mrSges(3,2) * t180) * t160 * t235 + t184 + t249 * g(2) + ((-t245 - t246) * t149 + t250) * g(1) + (t16 * t170 + t17 * t178 + (-t170 * t52 + t178 * t54) * qJD(4)) * t245 + (-t171 * t18 - t179 * t19 + (t171 * t53 + t179 * t55) * qJD(3)) * t246 + (-t68 * t108 + t254 * t116 - t3) * mrSges(11,2) + (-t73 * t114 + t252 * t117 - t5) * mrSges(10,2) + (t67 * t108 + t255 * t116) * mrSges(11,1) + (t70 * t114 + t253 * t117) * mrSges(10,1) - m(5) * (t52 * t62 + t54 * t65) - m(4) * (t53 * t63 - t55 * t66) - t63 * t145 * mrSges(4,1) + (t144 * t65 - t16) * mrSges(5,2) + (t145 * t66 - t18) * mrSges(4,2); -m(10) * (t22 * t27 - t23 * t28) - t27 * t233 + t195 * g(2) + (t117 * t28 - t5) * mrSges(10,2) + (-t145 * t55 + t239) * mrSges(4,1) + (g(1) * t129 + g(2) * t126 + t145 * t53 - t18) * mrSges(4,2) + ((t114 * t166 + t117 * t210) * mrSges(10,2) + (-t114 * t174 + t117 * t211) * mrSges(10,1) + (-g(2) * t129 - t166 * t5 - t174 * t6 + t210 * t23 + t211 * t22 + t239) * m(10)) * pkin(6) + t191 + t251; -m(11) * (t20 * t25 - t21 * t26) + t54 * t234 - g(1) * t219 + (t128 * mrSges(5,1) + t237) * g(2) + (t144 * t52 - t16) * mrSges(5,2) + (-t116 * t25 + t240) * mrSges(11,1) + (t116 * t26 + t185) * mrSges(11,2) + ((t108 * t164 + t116 * t207) * mrSges(11,2) + (-t108 * t165 + t116 * t208) * mrSges(11,1) + (-g(1) * t125 + g(2) * t128 - t164 * t3 - t165 * t4 + t20 * t208 + t207 * t21) * m(11)) * pkin(4) + t200; Ifges(6,3) * qJDD(5) - g(1) * (-mrSges(6,1) * t146 - mrSges(6,2) * t147) - g(2) * (mrSges(6,1) * t147 - mrSges(6,2) * t146); -g(1) * t77 - g(2) * t78 + t228 + t248; Ifges(8,3) * qJDD(7) - g(1) * (mrSges(8,1) * t176 - mrSges(8,2) * t168) - g(2) * (mrSges(8,1) * t168 + mrSges(8,2) * t176); -g(2) * t199 - g(1) * t194 + (-mrSges(9,1) * t167 - mrSges(9,2) * t175) * t159 * t235 + t196; -t23 * t233 - g(2) * t201 + (t117 * t22 - t5) * mrSges(10,2) + t191; -g(2) * t91 + (-t116 * t21 + t240) * mrSges(11,1) + (t116 * t20 + t185) * mrSges(11,2) + t242; 0; 0;];
tau = t1;
