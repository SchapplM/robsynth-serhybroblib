...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = picker2Dm2OL_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(8,1)}
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm2OL_pkin2mdhparam: Kinematic parameters pkin have to be [8x1] (double)');
