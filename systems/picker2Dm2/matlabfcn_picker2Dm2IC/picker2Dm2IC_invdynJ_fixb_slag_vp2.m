...
function tau = picker2Dm2IC_invdynJ_fixb_slag_vp2(qJ, qJD, qJDD, g, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
...
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm2IC_invdynJ_fixb_slag_vp2: qJ has to be [12x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [12 1]), ...
  'picker2Dm2IC_invdynJ_fixb_slag_vp2: qJD has to be [12x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [12 1]), ...
  'picker2Dm2IC_invdynJ_fixb_slag_vp2: qJDD has to be [12x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'picker2Dm2IC_invdynJ_fixb_slag_vp2: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm2IC_invdynJ_fixb_slag_vp2: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm2IC_invdynJ_fixb_slag_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'picker2Dm2IC_invdynJ_fixb_slag_vp2: mrSges has to be [11x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [11 6]), ...
  'picker2Dm2IC_invdynJ_fixb_slag_vp2: Ifges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From invdyn_fixb_par2_ic_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 09:20:45
% EndTime: 2020-05-11 09:20:52
...
t1 = t219 + (t204 * t22 + t212 * t23 + (-t204 * t60 + t212 * t62) * qJD(4)) * t316 + (-t205 * t24 - t213 * t25 + (t205 * t61 + t213 * t63) * qJD(3)) * t317 + (-t80 * t130 - t9 + (t39 - t46) * t144) * mrSges(11,2) + (-t85 * t142 - t11 + (t43 - t48) * t145) * mrSges(10,2) + (t79 * t130 + (-t38 + t47) * t144) * mrSges(11,1) + (t82 * t142 + (-t42 + t49) * t145) * mrSges(10,1) + (-t89 - m(11) * (t150 + t126) - m(10) * t255 + (-t316 - t317) * t180 + t232 - t238 + t276 - t280 - t281) * g(1) + t320 + (t174 * t77 - t22) * mrSges(5,2) - t74 * t306 - t75 * t307 + (-m(10) * t125 + t300 - t119 - t146 - t90 + (pkin(4) * m(11) + mrSges(5,1)) * t156 + (mrSges(3,1) + (m(11) + m(5)) * pkin(3) + (m(4) + m(10)) * pkin(2)) * t182 + t241 + t250) * g(2) + (t175 * t78 - t24) * mrSges(4,2) + (mrSges(3,1) * t206 + mrSges(3,2) * t214) * t193 * t308 + m(10) * (t11 * t85 + t12 * t82 + t28 * t49 - t29 * t48) - m(5) * (t60 * t74 + t62 * t77) - m(4) * (t61 * t75 - t63 * t78) + m(11) * (t10 * t79 + t26 * t47 - t27 * t46 + t80 * t9) - m(11) * (t26 * t38 - t27 * t39) - m(10) * (t28 * t42 - t29 * t43) + ((-t171 * t204 - t174 * t270) * mrSges(5,2) + (t171 * t212 - t174 * t271) * mrSges(5,1)) * pkin(3) + ((t172 * t205 + t175 * t272) * mrSges(4,2) + (-t172 * t213 + t175 * t273) * mrSges(4,1)) * pkin(2);
t7 = [t219 + t16 * t303 + t55 * t305 + t51 * t306 + t53 * t307 + (-t171 * t86 - t174 * t50 - t22) * mrSges(5,2) + (-t172 * t87 - t175 * t52 - t24) * mrSges(4,2) + (mrSges(7,1) * t94 + mrSges(7,2) * t95) * t170 + m(7) * (-t35 * t95 + t36 * t94 - t54 * t76 + t55 * t73) + (-pkin(1) * t193 * t274 - t191 * t314) * mrSges(3,2) - g(2) * (-m(3) * t313 + t146) + (g(2) * t182 + t189 * t191 - t193 * t260) * mrSges(3,1) + (t130 * t40 + t14 * t144) * mrSges(11,1) + (-t13 * t144 + t130 * t236 - t9) * mrSges(11,2) + m(11) * (t10 * t40 - t13 * t27 + t14 * t26 - t236 * t9) + (t142 * t235 - t145 * t15 - t11) * mrSges(10,2) + m(10) * (-t11 * t235 + t12 * t44 - t15 * t29 + t16 * t28) + t83 * t171 * mrSges(5,1) + t84 * t172 * mrSges(4,1) + t44 * t142 * mrSges(10,1) + t242 + (-t279 * pkin(5) + (-cos(qJ(8) + 0.2e1 * qJ(1)) + cos((2 * pkin(8)) + (2 * qJ(5)) + qJ(8))) * pkin(1)) * t216 / t279 * (-g(1) * t237 - g(2) * t252 - t308 * t322 + t242) + (-t209 * mrSges(9,1) + t201 * mrSges(9,2)) * pkin(1) * t190 - g(2) * (-m(9) * t313 + t252) - g(2) * (-m(7) * t313 + t90) - g(1) * (m(9) * t188 + t237) - g(1) * (m(7) * t188 + t89) - g(1) * (m(3) * t188 - t276) + (-(pkin(3) * (cos(t247) - cos(t246)) + (cos(-qJ(2) + t234) - cos(qJ(2) + t233)) * pkin(5)) * pkin(1) * t216 / (cos(t234) - cos(t233)) * t5 + (-pkin(1) * t178 - pkin(3) * t204) * t195 * t1 + (pkin(3) * t206 + pkin(4) * t178) * t2 * t263) * t218 - t54 * t302 - g(2) * (m(4) * t240 + t123 - t300) + m(5) * (t22 * t86 + t23 * t83 + t50 * t62 + t51 * t60) + m(4) * (t24 * t87 + t25 * t84 - t52 * t63 + t53 * t61) + (((t277 * t69 + t278 * t70) * t294 + (-(sin(t184) - sin(t183)) * t103 - (cos(t184) - cos(t183)) * t102) * t295) * t6 + ((-t282 * t69 - t283 * t70) * t294 + ((sin(t141) - sin(t140)) * t103 + (cos(t141) - cos(t140)) * t102) * t295) * t3) * pkin(2) + t201 / sin(-qJ(8) + t256) * (Ifges(6,3) * qJDD(5) - g(1) * (-mrSges(6,1) * t176 - mrSges(6,2) * t177) - g(2) * (mrSges(6,1) * t177 - mrSges(6,2) * t176)) + m(3) * (t206 * t99 + t214 * t98) * pkin(1) + m(9) * (-t201 * t97 - t209 * t96) * pkin(1) - g(1) * (m(11) * t70 - t232) - g(1) * (mrSges(2,1) * t207 + mrSges(2,2) * t215) - g(2) * (-mrSges(2,1) * t215 + mrSges(2,2) * t207) - g(1) * (m(4) * (t151 + t188) + t238) + pkin(1) * qJD(8) * t322 + Ifges(2,3) * qJDD(1) - t206 * t4 * t263 - g(2) * (-m(11) * t69 - t250) - g(2) * (m(10) * (t125 + t240) + t253) - g(2) * (m(5) * t239 + t254) - g(1) * (m(5) * t275 + t280) - g(1) * (m(10) * (t188 + t255) + t281); Ifges(8,3) * qJDD(7) - g(1) * (mrSges(8,1) * t210 - mrSges(8,2) * t202) - g(2) * (mrSges(8,1) * t202 + mrSges(8,2) * t210) + ((-t278 * t6 + t283 * t3) * t210 + (t277 * t6 - t282 * t3) * t202) * t56 * pkin(2) + (-(t1 + t5) * t230 + ((t2 * t230 + t231 * t4) * pkin(4) + (t2 - t4) * pkin(3) * (t180 * t202 + t182 * t210)) * t217) / t231;];
tau = t7(:);
