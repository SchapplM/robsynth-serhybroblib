...
function taug = picker2Dm2IC_gravloadJ_floatb_twist_snew_vp2(qJ, g, ...
  pkin, m, mrSges)
%% Coder Information
%#codegen
%$cgargs {zeros(12,1),zeros(3,1),zeros(8,1),zeros(11,1),zeros(11,3)}
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm2IC_gravloadJ_floatb_twist_snew_vp2: qJ has to be [12x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'picker2Dm2IC_gravloadJ_floatb_twist_snew_vp2: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm2IC_gravloadJ_floatb_twist_snew_vp2: pkin has to be [8x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'picker2Dm2IC_gravloadJ_floatb_twist_snew_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'picker2Dm2IC_gravloadJ_floatb_twist_snew_vp2: mrSges has to be [11x3] (double)');

%% Symbolic Calculation
% From gravload_joint_floatb_twist_snew_par2_ic_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 09:21:05
% EndTime: 2020-05-11 09:21:06
...
t1 = [-pkin(5) * t320 + mrSges(2,1) * t239 - mrSges(2,2) * t240 + t188 - t276 * t201 * t307 + t270 / sin(-qJ(8) + t305) * (mrSges(6,1) * (g(1) * t231 - g(2) * t232) - mrSges(6,2) * (-g(1) * t232 - g(2) * t231)) + t304 + (((t310 * t229 + t309 * t230) * t317 + (-(sin(t259) - sin(t258)) * t234 - (cos(t259) - cos(t258)) * t233) * t318) * t209 + ((-t313 * t229 - t312 * t230) * t317 + ((sin(t250) - sin(t249)) * t234 + (cos(t250) - cos(t249)) * t233) * t318) * t192) * pkin(2) + ((-t223 * t279 - t225 * t270) * m(9) + (-cos(qJ(8) + 0.2e1 * qJ(1)) + cos(0.2e1 * pkin(8) + 0.2e1 * qJ(5) + qJ(8))) / (-cos(0.2e1 * t263) + cos(0.2e1 * t308)) * t320 + t276 * (m(3) * t226 - t195 * t274 + t196 * t283 + t197 * t275 - t198 * t284) + t285 * (m(3) * t224 + t297 + t314) + (t276 * (t213 * t272 - t216 * t281) + t285 * (-t213 * t281 - t216 * t272)) * m(7)) * pkin(1) + ((-pkin(1) * t255 - pkin(3) * t274) * t262 * t188 + (pkin(3) * t276 + pkin(4) * t255) * t191 * t307 - (pkin(3) * (cos(t303) - cos(t302)) + (cos(-qJ(2) + t299) - cos(qJ(2) + t298)) * pkin(5)) * pkin(1) * t287 / (cos(t299) - cos(t298)) * t202) * t289; mrSges(8,1) * (-g(1) * t280 - g(2) * t271) - mrSges(8,2) * (-g(1) * t271 + g(2) * t280) + ((t313 * t192 - t310 * t209) * t280 + (-t312 * t192 + t309 * t209) * t271) * t220 * pkin(2) + (((t295 * t191 + t296 * t201) * pkin(4) + (t191 - t201) * pkin(3) * (t256 * t271 + t257 * t280)) * t288 - (t188 + t202) * t295) / t296;];
taug = t1(:);
