...
function tau_reg = picker2Dm2IC_invdynJ_fixb_reg2_slag_vp(qJ, qJD, qJDD, g, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(12,1),zeros(12,1),zeros(12,1),zeros(3,1),zeros(8,1)}
assert(isreal(qJ) && all(size(qJ) == [12 1]), ...
  'picker2Dm2IC_invdynJ_fixb_reg2_slag_vp: qJ has to be [12x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [12 1]), ...
  'picker2Dm2IC_invdynJ_fixb_reg2_slag_vp: qJD has to be [12x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [12 1]), ...
  'picker2Dm2IC_invdynJ_fixb_reg2_slag_vp: qJDD has to be [12x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'picker2Dm2IC_invdynJ_fixb_reg2_slag_vp: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [8 1]), ...
  'picker2Dm2IC_invdynJ_fixb_reg2_slag_vp: pkin has to be [8x1] (double)');

%% Symbolic Calculation
% From invdyn_fixb_regressor_ic_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-11 09:20:55
% EndTime: 2020-05-11 09:21:00
...
t88 = pkin(1) * t257 * t325 + t310;
t85 = t213 * t358 + (qJD(2) * t290 + t257 * t357) * pkin(1);
t84 = -t213 * t357 + (t257 * t358 + (-t264 * t265 + t373) * qJD(2)) * pkin(1);
t83 = -t212 * t355 + (qJD(2) * t292 - t331) * pkin(1);
t82 = t212 * t354 + (qJD(2) * t291 - t257 * t355) * pkin(1);
t66 = pkin(4) * t297 - t414;
t63 = -t101 * t259 - t387;
t62 = t101 * t251 - t386;
t61 = -t100 * t250 + t389;
t60 = t100 * t249 + t388;
...
t34 = qJD(9) * t298 + t251 * t84 - t259 * t85;
t33 = qJD(9) * t74 - t251 * t85 - t259 * t84;
t32 = qJD(10) * t299 + t249 * t82 - t250 * t83;
t31 = qJD(10) * t70 - t249 * t83 - t250 * t82;
