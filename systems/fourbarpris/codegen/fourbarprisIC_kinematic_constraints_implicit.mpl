...
Trf
;
# Slider_Crank 0-1-2-5-4-3-0
# Schleife 0-1-2-5
T_0_5 := combine(Matrix(Trf(1..4,1..4, 1)) . Matrix(Trf(1..4,1..4,2)). Matrix(Trf(1..4,1..4, 5)));
# Schleife 0-3-4
T_0_4:= combine(Matrix(Trf(1..4,1..4, 3)) . Matrix(Trf(1..4,1..4,4)));
