...
function T = fourbarprisTE_energykin_floatb_twist_slag_vp1(qJ, qJD, V_base, ...
  pkin, m, rSges, Icges)
%% Coder Information
%#codegen
%$cgargs {zeros(1,1),zeros(1,1),zeros(6,1),zeros(3,1),zeros(4,1),zeros(4,3),zeros(4,6)}
assert(isreal(qJ) && all(size(qJ) == [1 1]), ...
  'fourbarprisTE_energykin_floatb_twist_slag_vp1: qJ has to be [1x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [1 1]), ...
  'fourbarprisTE_energykin_floatb_twist_slag_vp1: qJD has to be [1x1] (double)');
assert(isreal(V_base) && all(size(V_base) == [6 1]), ...
  'fourbarprisTE_energykin_floatb_twist_slag_vp1: V_base has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [3 1]), ...
  'fourbarprisTE_energykin_floatb_twist_slag_vp1: pkin has to be [3x1] (double)');
assert(isreal(m) && all(size(m) == [4 1]), ...
  'fourbarprisTE_energykin_floatb_twist_slag_vp1: m has to be [4x1] (double)'); 
assert(isreal(rSges) && all(size(rSges) == [4,3]), ...
  'fourbarprisTE_energykin_floatb_twist_slag_vp1: rSges has to be [4x3] (double)');
assert(isreal(Icges) && all(size(Icges) == [4 6]), ...
  'fourbarprisTE_energykin_floatb_twist_slag_vp1: Icges has to be [4x6] (double)'); 

%% Symbolic Calculation
% From energy_kinetic_floatb_twist_worldframe_par1_matlab.m
% OptimizationMode: 2
% StartTime: 2020-05-07 09:01:07
% EndTime: 2020-05-07 09:01:12
...
t180 = (-t131 * t108 + t96 * t137 + t107 * t92 / 0.4e1) * t114;
t162 = t118 + t120;
t98 = -t117 + t162;
t179 = t98 - t145;
t178 = pkin(1) * pkin(2);
...
t85 = t96 * t148;
t84 = ((t116 / 0.2e1 + t115 / 0.2e1 + rSges(4,3) ^ 2) * m(4) + Icges(4,1) / 0.2e1 + Icges(4,2) / 0.2e1) * t118;
t79 = t148 * t92 - 0.2e1 * t135;
...
t68 = Icges(3,1) * t146 * t90 + t80;
t67 = (-t166 / 0.2e1 + Icges(2,2) * t176) * t165;
t66 = Icges(2,2) * t122 * t146 + t83;
t59 = t147 * t73 * t77 + V_base(5) * rSges(2,3) + V_base(1);
t58 = t146 * t73 * t75 - V_base(4) * rSges(2,3) + t158;
t57 = (t155 * t75 + t156 * t77) * t165 + t133;
t56 = (t74 * t156 + t76 * t155 + (t154 * t90 + t173 * V_base(4)) * qJ(1)) * t165 + t133;
