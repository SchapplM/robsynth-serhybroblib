...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = fourbarprisTE_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(3,1)}
assert(isreal(pkin) && all(size(pkin) == [3 1]), ...
  'fourbarprisTE_pkin2mdhparam: Kinematic parameters pkin have to be [3x1] (double)');
