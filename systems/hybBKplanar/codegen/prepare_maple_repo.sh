...
cp $this_path/hybBKplanar_kinematic_constraints.mpl $constrpath/hybBKplanar_kinematic_constraints.mpl

# Werte für Kinematikparameter (für Modultests)
cp $this_path/hybBKplanar_kinematic_parameter_values.m $constrpath/hybBKplanar_kinematic_parameter_values.m

# Winkelgrenzen für die Modultests
cp $this_path/hybBKplanar_kinematic_constraints_matlab.m $constrpath/hybBKplanar_kinematic_constraints_matlab.m
