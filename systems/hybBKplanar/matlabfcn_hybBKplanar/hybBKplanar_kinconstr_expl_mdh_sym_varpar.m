...
function jv = hybBKplanar_kinconstr_expl_mdh_sym_varpar(qJ, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(3,1),zeros(6,1)}
assert(isreal(qJ) && all(size(qJ) == [3 1]), ...
  'hybBKplanar_kinconstr_expl_mdh_sym_varpar: qJ has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [6 1]), ...
  'hybBKplanar_kinconstr_expl_mdh_sym_varpar: pkin has to be [6x1] (double)');

%% Symbolic Calculation
% From kinconstr_expl_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-11 18:51:51
% EndTime: 2020-04-11 18:51:54
...
t226 = t73 + t115;
t50 = t127 + t133;
t229 = ((t73 + t116) * t127 - 0.3e1 / 0.2e1 * t224 + t217 + t241) * t50 + t128;
...
t3 = [qJ(1); atan2(t1 * t20 + t2 * t21, t1 * t21 - t2 * t20); qJ(2); atan2(t6 * t181, t5 * t181); qJ(3); atan2(t7 * t173, t173 * t254); 0;];
jv = t3(:);
