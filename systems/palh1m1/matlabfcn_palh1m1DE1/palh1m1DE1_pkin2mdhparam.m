...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = palh1m1DE1_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(23,1)}
assert(isreal(pkin) && all(size(pkin) == [23 1]), ...
  'palh1m1DE1_pkin2mdhparam: Kinematic parameters pkin have to be [23x1] (double)');
