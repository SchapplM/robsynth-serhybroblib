...
function [v_mdh, sigma_mdh, mu_mdh, NL, NKP, NQJ, pkin_names] = palh1m1OL_structural_kinematic_parameters()
...
pkin_names = {'AB', 'AM', 'BC', 'BE', 'BG', 'BL', 'DC', 'EP', 'GH', 'GP', 'HW', 'ML', 'OT2', 'T1D', 'T2A', 'T2T1', 'phi312', 'phi413', 'phi710', 'phi711'};
