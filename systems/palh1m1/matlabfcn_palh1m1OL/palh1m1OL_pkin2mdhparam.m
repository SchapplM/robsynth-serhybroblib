...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = palh1m1OL_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(20,1)}
assert(isreal(pkin) && all(size(pkin) == [20 1]), ...
  'palh1m1OL_pkin2mdhparam: Kinematic parameters pkin have to be [20x1] (double)');
