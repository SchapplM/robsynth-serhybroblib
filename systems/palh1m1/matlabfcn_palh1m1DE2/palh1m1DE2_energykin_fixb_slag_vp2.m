...
function T = palh1m1DE2_energykin_fixb_slag_vp2(qJ, qJD, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(4,1),zeros(23,1),zeros(11,1),zeros(11,3),zeros(11,6)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh1m1DE2_energykin_fixb_slag_vp2: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'palh1m1DE2_energykin_fixb_slag_vp2: qJD has to be [4x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [23 1]), ...
  'palh1m1DE2_energykin_fixb_slag_vp2: pkin has to be [23x1] (double)');
assert(isreal(m) && all(size(m) == [11 1]), ...
  'palh1m1DE2_energykin_fixb_slag_vp2: m has to be [11x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [11,3]), ...
  'palh1m1DE2_energykin_fixb_slag_vp2: mrSges has to be [11x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [11 6]), ...
  'palh1m1DE2_energykin_fixb_slag_vp2: Ifges has to be [11x6] (double)'); 

%% Symbolic Calculation
% From energy_kinetic_fixb_linkframe_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-14 20:03:04
% EndTime: 2020-04-14 20:03:57
...
t362 = 0.1e1 / t363 ^ 2;
t361 = ((t411 * t535 + t430 * t528 + t408 * t567 / 0.2e1 + t427 * t529) / t421 - (t408 * t535 + t427 * t528 - t411 * t567 / 0.2e1 - t430 * t529) * t422 * t418) / (t418 * t422 ^ 2 + 0.1e1) * t508;
...
t329 = ((t341 * t540 + t364 * t527 + t342 * t574 / 0.2e1 + t366 * t526) / t353 - (-t341 * t574 / 0.2e1 - t364 * t526 + t342 * t540 + t366 * t527) * t352 * t351) / (t351 * t352 ^ 2 + 0.1e1) * t504 + t479;
...
t1 = Ifges(9,1) * t389 ^ 2 / 0.2e1 + (Ifges(9,4) * t389 + Ifges(9,2) * t388 / 0.2e1) * t388 + (t323 * mrSges(6,1) - t324 * mrSges(6,2) + Ifges(6,3) * t336 / 0.2e1) * t336 + (Ifges(9,5) * t389 + Ifges(9,6) * t388 + Ifges(9,3) * t372 / 0.2e1 + (-t432 * (-mrSges(10,2) * t369 + mrSges(10,3) * t374) - t433 * (mrSges(10,1) * t369 - mrSges(10,3) * t375)) * pkin(2)) * t372 + (-t327 * mrSges(6,1) + t324 * mrSges(6,3) + Ifges(6,4) * t326 + Ifges(6,6) * t336 + Ifges(6,2) * t325 / 0.2e1) * t325 + Ifges(4,3) * t479 ^ 2 / 0.2e1 + (t332 * mrSges(11,1) - t333 * mrSges(11,2) + Ifges(11,5) * t335 + Ifges(11,6) * t334 + Ifges(11,3) * t330 / 0.2e1) * t330 + (-pkin(16) * (-mrSges(9,1) * t388 + mrSges(9,2) * t389) + t361 * (Ifges(7,5) * t403 + Ifges(7,6) * t404) + qJD(2) * (Ifges(3,5) * t495 - Ifges(3,6) * t490) + ((-pkin(16) * mrSges(3,2) + Ifges(3,1) * t495 / 0.2e1) * t495 + (-pkin(15) * mrSges(7,1) + Ifges(7,2) * t404 / 0.2e1) * t404 + (-pkin(16) * mrSges(3,1) - Ifges(3,4) * t495 + Ifges(3,2) * t490 / 0.2e1) * t490 + (pkin(15) * mrSges(7,2) + Ifges(7,4) * t404 + Ifges(7,1) * t403 / 0.2e1) * t403 + m(7) * pkin(15) ^ 2 / 0.2e1 + Ifges(2,3) / 0.2e1 + (m(9) / 0.2e1 + m(3) / 0.2e1) * pkin(16) ^ 2) * qJD(1)) * qJD(1) + (t339 * mrSges(5,1) - t340 * mrSges(5,2) + Ifges(5,5) * t338 + Ifges(5,6) * t337 + Ifges(5,3) * t329 / 0.2e1) * t329 + (Ifges(8,5) * t381 + Ifges(8,6) * t380 + Ifges(8,3) * t360 / 0.2e1) * t360 + (Ifges(3,3) * qJD(2) / 0.2e1 + (t489 * (mrSges(4,1) * t479 - mrSges(4,3) * t464) - t494 * (-mrSges(4,2) * t479 + mrSges(4,3) * t465) + t400 * (-mrSges(8,2) * t360 + mrSges(8,3) * t380) + t401 * (mrSges(8,1) * t360 - mrSges(8,3) * t381)) * pkin(1)) * qJD(2) + (t327 * mrSges(6,2) - t323 * mrSges(6,3) + Ifges(6,5) * t336 + Ifges(6,1) * t326 / 0.2e1) * t326 + Ifges(7,3) * t361 ^ 2 / 0.2e1 + (-t385 * mrSges(10,1) + Ifges(10,4) * t375 + Ifges(10,2) * t374 / 0.2e1) * t374 + (-t370 * mrSges(11,1) + t333 * mrSges(11,3) + Ifges(11,4) * t335 + Ifges(11,2) * t334 / 0.2e1) * t334 + (Ifges(10,5) * t375 + Ifges(10,6) * t374 + Ifges(10,3) * t369 / 0.2e1) * t369 + (t385 * mrSges(10,2) + Ifges(10,1) * t375 / 0.2e1) * t375 + m(4) * (t473 + (t489 ^ 2 + t494 ^ 2) * t555) / 0.2e1 + m(8) * (t473 + (t400 ^ 2 + t401 ^ 2) * t555) / 0.2e1 + (t474 * mrSges(8,2) + Ifges(8,1) * t381 / 0.2e1) * t381 + m(10) * (t385 ^ 2 + (t432 ^ 2 + t433 ^ 2) * t515 * t372 ^ 2) / 0.2e1 + m(6) * (t323 ^ 2 + t324 ^ 2 + t327 ^ 2) / 0.2e1 + m(11) * (t332 ^ 2 + t333 ^ 2 + t370 ^ 2) / 0.2e1 + (t474 * mrSges(4,2) + Ifges(4,4) * t465 + Ifges(4,5) * t479 + Ifges(4,1) * t464 / 0.2e1) * t464 + (-t474 * mrSges(8,1) + Ifges(8,4) * t381 + Ifges(8,2) * t380 / 0.2e1) * t380 + (-t441 * mrSges(5,1) + t340 * mrSges(5,3) + Ifges(5,4) * t338 + Ifges(5,2) * t337 / 0.2e1) * t337 + (t370 * mrSges(11,2) - t332 * mrSges(11,3) + Ifges(11,1) * t335 / 0.2e1) * t335 + m(5) * (t339 ^ 2 + t340 ^ 2 + t441 ^ 2) / 0.2e1 + (t441 * mrSges(5,2) - t339 * mrSges(5,3) + Ifges(5,1) * t338 / 0.2e1) * t338 + (-t474 * mrSges(4,1) + Ifges(4,6) * t479 + Ifges(4,2) * t465 / 0.2e1) * t465;
T = t1;
