...
function [v_mdh, sigma_mdh, mu_mdh, NL, NKP, NQJ, pkin_names] = mg10hlOL_structural_kinematic_parameters()
...
pkin_names = {'AC', 'CG', 'DC', 'ED', 'GK', 'GP', 'HP', 'LW', 'ML', 'OT', 'PM', 'TA', 'TE', 'phi23', 'phi3', 'phi34'};
