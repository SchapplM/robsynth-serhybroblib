...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = mg10hlDE2_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(17,1)}
assert(isreal(pkin) && all(size(pkin) == [17 1]), ...
  'mg10hlDE2_pkin2mdhparam: Kinematic parameters pkin have to be [17x1] (double)');
