...
function T = palh3m1DE2_energykin_fixb_slag_vp2(qJ, qJD, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(4,1),zeros(19,1),zeros(9,1),zeros(9,3),zeros(9,6)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh3m1DE2_energykin_fixb_slag_vp2: qJ has to be [4x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [4 1]), ...
  'palh3m1DE2_energykin_fixb_slag_vp2: qJD has to be [4x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [19 1]), ...
  'palh3m1DE2_energykin_fixb_slag_vp2: pkin has to be [19x1] (double)');
assert(isreal(m) && all(size(m) == [9 1]), ...
  'palh3m1DE2_energykin_fixb_slag_vp2: m has to be [9x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [9,3]), ...
  'palh3m1DE2_energykin_fixb_slag_vp2: mrSges has to be [9x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [9 6]), ...
  'palh3m1DE2_energykin_fixb_slag_vp2: Ifges has to be [9x6] (double)'); 

%% Symbolic Calculation
% From energy_kinetic_fixb_linkframe_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-19 19:35:20
% EndTime: 2020-04-19 19:36:06
% DurationCPUTime: 44.81s
...
t290 = 0.1e1 / t291 ^ 2;
t289 = ((t329 * t412 + t384 * t408 - t326 * t430 / 0.2e1 - t379 * t405) / t334 - (t326 * t412 + t384 * t405 + t329 * t430 / 0.2e1 + t379 * t408) * t337 * t331) / (t331 * t337 ^ 2 + 0.1e1) * t392;
...
t257 = ((t270 * t442 / 0.2e1 + t370 * t406 + t269 * t415 + t369 * t407) / t280 - (-t269 * t442 / 0.2e1 - t370 * t407 + t270 * t415 + t369 * t406) * t281 * t279) / (t279 * t281 ^ 2 + 0.1e1) * t388 + t367;
...
t1 = Ifges(4,3) * t367 ^ 2 / 0.2e1 + Ifges(7,3) * t289 ^ 2 / 0.2e1 + m(9) * (t260 ^ 2 + t261 ^ 2 + t297 ^ 2) / 0.2e1 + m(6) * (t251 ^ 2 + t252 ^ 2 + t255 ^ 2) / 0.2e1 + m(4) * (t363 + (t376 ^ 2 + t381 ^ 2) * t425) / 0.2e1 + m(8) * (t363 + (t318 ^ 2 + t319 ^ 2) * t425) / 0.2e1 + m(5) * (t267 ^ 2 + t268 ^ 2 + t345 ^ 2) / 0.2e1 + (t364 * mrSges(8,2) + Ifges(8,1) * t304 / 0.2e1) * t304 + (-t364 * mrSges(8,1) + Ifges(8,4) * t304 + Ifges(8,2) * t303 / 0.2e1) * t303 + (t345 * mrSges(5,2) - t267 * mrSges(5,3) + Ifges(5,1) * t266 / 0.2e1) * t266 + (t251 * mrSges(6,1) - t252 * mrSges(6,2) + Ifges(6,3) * t264 / 0.2e1) * t264 + (t297 * mrSges(9,2) - t260 * mrSges(9,3) + Ifges(9,1) * t263 / 0.2e1) * t263 + (t364 * mrSges(4,2) + Ifges(4,5) * t367 + Ifges(4,1) * t357 / 0.2e1) * t357 + (-t345 * mrSges(5,1) + t268 * mrSges(5,3) + Ifges(5,4) * t266 + Ifges(5,2) * t265 / 0.2e1) * t265 + (-t297 * mrSges(9,1) + t261 * mrSges(9,3) + Ifges(9,4) * t263 + Ifges(9,2) * t262 / 0.2e1) * t262 + (t255 * mrSges(6,2) - t251 * mrSges(6,3) + Ifges(6,5) * t264 + Ifges(6,1) * t254 / 0.2e1) * t254 + (-t364 * mrSges(4,1) + Ifges(4,4) * t357 + Ifges(4,6) * t367 + Ifges(4,2) * t356 / 0.2e1) * t356 + (Ifges(8,5) * t304 + Ifges(8,6) * t303 + Ifges(8,3) * t288 / 0.2e1) * t288 + (t260 * mrSges(9,1) - t261 * mrSges(9,2) + Ifges(9,5) * t263 + Ifges(9,6) * t262 + Ifges(9,3) * t258 / 0.2e1) * t258 + (t267 * mrSges(5,1) - t268 * mrSges(5,2) + t266 * Ifges(5,5) + t265 * Ifges(5,6) + Ifges(5,3) * t257 / 0.2e1) * t257 + (-t255 * mrSges(6,1) + t252 * mrSges(6,3) + Ifges(6,4) * t254 + Ifges(6,6) * t264 + Ifges(6,2) * t253 / 0.2e1) * t253 + (Ifges(3,3) * qJD(2) / 0.2e1 + (t318 * (-mrSges(8,2) * t288 + mrSges(8,3) * t303) + t319 * (mrSges(8,1) * t288 - mrSges(8,3) * t304) - t376 * (-mrSges(4,2) * t367 + mrSges(4,3) * t356) - t381 * (mrSges(4,1) * t367 - mrSges(4,3) * t357)) * pkin(1)) * qJD(2) + (t289 * (Ifges(7,5) * t321 + Ifges(7,6) * t322) + qJD(2) * (Ifges(3,5) * t377 + Ifges(3,6) * t382) + (m(3) * pkin(13) ^ 2 / 0.2e1 + m(7) * pkin(7) ^ 2 / 0.2e1 + Ifges(2,3) / 0.2e1 + (pkin(13) * mrSges(3,1) + Ifges(3,2) * t382 / 0.2e1) * t382 + (-pkin(7) * mrSges(7,1) + Ifges(7,2) * t322 / 0.2e1) * t322 + (-pkin(13) * mrSges(3,2) + Ifges(3,4) * t382 + Ifges(3,1) * t377 / 0.2e1) * t377 + (pkin(7) * mrSges(7,2) + Ifges(7,4) * t322 + Ifges(7,1) * t321 / 0.2e1) * t321) * qJD(1)) * qJD(1);
T = t1;
