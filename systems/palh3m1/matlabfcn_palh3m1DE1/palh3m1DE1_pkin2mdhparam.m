...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = palh3m1DE1_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(19,1)}
assert(isreal(pkin) && all(size(pkin) == [19 1]), ...
  'palh3m1DE1_pkin2mdhparam: Kinematic parameters pkin have to be [19x1] (double)');
