...
function Mq = palh3m1DE1_inertiaJ_slag_vp2(qJ, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(4,1),zeros(19,1),zeros(9,1),zeros(9,3),zeros(9,6)}
assert(isreal(qJ) && all(size(qJ) == [4 1]), ...
  'palh3m1DE1_inertiaJ_slag_vp2: qJ has to be [4x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [19 1]), ...
  'palh3m1DE1_inertiaJ_slag_vp2: pkin has to be [19x1] (double)');
assert(isreal(m) && all(size(m) == [9 1]), ...
  'palh3m1DE1_inertiaJ_slag_vp2: m has to be [9x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [9,3]), ...
  'palh3m1DE1_inertiaJ_slag_vp2: mrSges has to be [9x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [9 6]), ...
  'palh3m1DE1_inertiaJ_slag_vp2: Ifges has to be [9x6] (double)'); 

%% Symbolic Calculation
% From inertia_joint_joint_floatb_twist_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-18 10:54:01
% EndTime: 2020-04-18 11:05:18
% DurationCPUTime: 127.58s
...
t215 = -t237 / 0.2e1;
t233 = t140 * t179;
t106 = (t233 + (t134 * t310 - t129 + t215) * t142) * pkin(5);
...
t8 = -pkin(9) * t12 - t38;
t306 = m(6) * t8;
t141 = -t159 * t165 - t160 * t164;
t36 = t141 * t46 - t191 * t47;
t305 = t36 / 0.2e1;
t303 = t87 / 0.2e1;
t170 = 0.1e1 / pkin(8);
t217 = t170 * t303;
...
t271 = t163 * t5;
t266 = t38 * mrSges(5,1);
t39 = t46 * t146 - t273 * t47;
t265 = t39 * mrSges(5,2);
t263 = t315 * t12;
t262 = t315 * t18;
t37 = t141 * t47 + t191 * t46;
t253 = t163 * t37;
...
t172 = 0.1e1 / pkin(6);
t235 = t131 * t172;
t230 = Ifges(4,5) * t141 + Ifges(4,6) * t191;
t229 = t158 ^ 2 + t163 ^ 2;
t214 = t131 * t284;
...
t181 = t158 * t20 / 0.2e1 + t19 * t285 + t37 * Ifges(5,5) - t36 * Ifges(5,6);
t135 = pkin(1) * t140 - pkin(5);
t128 = t133 - t227;
t122 = pkin(1) * t142 * t128 - t135 * t179;
...
t105 = (t233 + (0.2e1 * t135 * pkin(5) - t128 + t215) * t142) * pkin(1);
t104 = atan2(t116, t113);
t101 = cos(t104);
t100 = sin(t104);
t72 = (-t155 * t79 - t157 * t78) * pkin(3) + t144;
t64 = ((t107 * t214 + t122 * t199 - t105 * t236 / 0.2e1 - t119 * t200) / t113 - (t105 * t214 + t119 * t199 + t107 * t236 / 0.2e1 + t122 * t200) * t116 * t110) / (t110 * t116 ^ 2 + 0.1e1) * t172;
t30 = -t44 * t61 + t45 * t62;
t29 = 0.2e1 * ((t71 * t223 + (t94 * t85 - t312) * pkin(4)) * t303 + t192 * t182) * t201 - 0.2e1 * ((-t192 * t85 + t184) * t303 + t192 * t189) * t187;
t25 = t197 * t37;
...
t4 = t198 * t18;
t1 = t198 * t12;
t7 = [(mrSges(5,2) * t309 + Ifges(5,1) * t37 - 0.2e1 * Ifges(5,4) * t36 + t163 * t20 + (-t19 - t278) * t158) * t37 + (mrSges(5,1) * t309 + Ifges(5,2) * t36 + t261) * t36 + (m(4) + m(8)) * t144 ^ 2 + m(3) * pkin(13) ^ 2 + m(7) * pkin(7) ^ 2 + t32 * (Ifges(9,4) * t33 + Ifges(9,2) * t32) + t33 * (Ifges(9,1) * t33 + t32 * Ifges(9,4)) + m(5) * t130 ^ 2 + 0.2e1 * pkin(7) * (-mrSges(7,1) * t101 + mrSges(7,2) * t100) + t101 * (Ifges(7,4) * t100 + Ifges(7,2) * t101) + t100 * (Ifges(7,1) * t100 + Ifges(7,4) * t101) + m(9) * t72 ^ 2 + 0.2e1 * t72 * (-mrSges(9,1) * t32 + mrSges(9,2) * t33) - 0.2e1 * pkin(13) * (-mrSges(3,1) * t165 + mrSges(3,2) * t160) + t165 * (Ifges(3,4) * t160 + Ifges(3,2) * t165) + t160 * (Ifges(3,1) * t160 + Ifges(3,4) * t165) + Ifges(2,3) + (mrSges(8,2) * t307 + Ifges(8,1) * t79) * t79 + (-mrSges(8,1) * t307 + 0.2e1 * Ifges(8,4) * t79 + Ifges(8,2) * t78) * t78 + (0.2e1 * t158 * t26 + 0.2e1 * t163 * t27 + t186 * t24) * t24 + (-mrSges(4,1) * t307 + Ifges(4,2) * t191) * t191 + (mrSges(4,2) * t307 + Ifges(4,1) * t141 + 0.2e1 * t191 * Ifges(4,4)) * t141; t8 * t25 - t39 * t279 + Ifges(3,5) * t160 + Ifges(3,6) * t165 + t263 * t305 + t194 * t9 + (-t30 * t33 + t31 * t32) * mrSges(9,3) + (-t38 * mrSges(5,3) + t2 * t287 + t285 * t3) * t37 + t183 * t21 + ((t97 * t78 - t98 * t79) * mrSges(8,3) + (t164 * t141 - t159 * t191) * mrSges(4,3)) * pkin(1) + t181 * t12 + t64 * (Ifges(7,5) * t100 + Ifges(7,6) * t101) + t63 * (Ifges(8,5) * t79 + Ifges(8,6) * t78) + t230; m(9) * t31 ^ 2 + (t38 ^ 2 + t39 ^ 2) * m(5) + t63 ^ 2 * Ifges(8,3) + t64 ^ 2 * Ifges(7,3) + Ifges(3,3) + Ifges(4,3) + (0.2e1 * t1 + t306) * t8 + t9 ^ 2 * t186 + (t276 - 0.2e1 * t280) * t21 + (m(9) * t30 + 0.2e1 * mrSges(9,1) * t21) * t30 + (m(4) * (t159 ^ 2 + t164 ^ 2) + m(8) * (t97 ^ 2 + t98 ^ 2)) * t178 + 0.2e1 * ((mrSges(8,1) * t98 - mrSges(8,2) * t97) * t63 + t311) * pkin(1) + (t12 * Ifges(5,3) + t193 * t9 - 0.2e1 * t265 + 0.2e1 * t266 + t272 + t275) * t12; t262 * t305 + t15 * t25 - t279 * t296 + t194 * t14 + (-mrSges(5,3) * t295 + t285 * t6 + t287 * t5) * t37 + t183 * t29 + t181 * t18 + t230; t8 * t4 + Ifges(4,3) + (t1 + t306) * t15 + t9 * t14 * t186 + (t38 * t47 + t39 * t46) * pkin(4) * m(5) + t311 * pkin(1) + (mrSges(9,1) * t30 + t276 - t280) * t29 + (t266 + t275 / 0.2e1 + t272 / 0.2e1 - t265 + t9 * t210) * t18 + (t277 + t271 / 0.2e1 + t274 / 0.2e1 + t14 * t210 + t188) * t12; t29 ^ 2 * Ifges(9,3) + Ifges(4,3) + (t46 ^ 2 + t47 ^ 2) * t174 * m(5) + (m(6) * t15 + 0.2e1 * t4) * t15 + t14 ^ 2 * t186 + (t14 * t193 + 0.2e1 * t188 + t271 + t274 + t277) * t18; t24 * t260 + (-mrSges(6,2) * t24 - Ifges(6,6) * t37) * t158 + t261; -t197 * t9 + t263; -t14 * t197 + t262; Ifges(6,3);];
