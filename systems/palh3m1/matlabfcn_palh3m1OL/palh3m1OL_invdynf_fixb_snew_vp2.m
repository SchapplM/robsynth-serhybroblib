...
function f_new = palh3m1OL_invdynf_fixb_snew_vp2(qJ, qJD, qJDD, g, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(10,1),zeros(10,1),zeros(10,1),zeros(3,1),zeros(16,1),zeros(9,1),zeros(9,3),zeros(9,6)}
assert(isreal(qJ) && all(size(qJ) == [10 1]), ...
  'palh3m1OL_invdynf_fixb_snew_vp2: qJ has to be [10x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [10 1]), ...
  'palh3m1OL_invdynf_fixb_snew_vp2: qJD has to be [10x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [10 1]), ...
  'palh3m1OL_invdynf_fixb_snew_vp2: qJDD has to be [10x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'palh3m1OL_invdynf_fixb_snew_vp2: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [16 1]), ...
  'palh3m1OL_invdynf_fixb_snew_vp2: pkin has to be [16x1] (double)');
assert(isreal(m) && all(size(m) == [9 1]), ...
  'palh3m1OL_invdynf_fixb_snew_vp2: m has to be [9x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [9,3]), ...
  'palh3m1OL_invdynf_fixb_snew_vp2: mrSges has to be [9x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [9 6]), ...
  'palh3m1OL_invdynf_fixb_snew_vp2: Ifges has to be [9x6] (double)'); 

%% Symbolic Calculation
% From invdyn_fixb_NewtonEuler_linkframe_f_i_i_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-20 17:04:12
...
t131 = sin(qJ(1));
t139 = cos(qJ(1));
t154 = -t139 * g(1) - t131 * g(2);
t98 = -t140 * pkin(12) + t154;
...
t55 = t95 * t90 - t94 * t92;
t103 = t130 * qJDD(1) + t138 * t162;
t158 = t130 * t162;
t105 = t138 * qJDD(1) - t158;
t61 = -t92 * qJD(7) - t125 * t103 + t133 * t105;
t63 = t90 * qJD(7) + t133 * t103 + t125 * t105;
t27 = t55 * qJD(8) + t94 * t61 + t95 * t63;
t118 = t121 ^ 2;
t67 = (-t123 * t92 - t124 * t90) * pkin(3);
t33 = -t92 * t67 + (t118 * t123 + t119 * t124) * pkin(3) + t156;
t34 = t90 * t67 + (-t118 * t124 + t119 * t123) * pkin(3) + t167;
t56 = t94 * t90 + t95 * t92;
t36 = -t55 * mrSges(9,1) + t56 * mrSges(9,2);
t53 = -t115 * mrSges(9,2) + t55 * mrSges(9,3);
t17 = m(9) * (t95 * t33 - t94 * t34) - t27 * mrSges(9,3) + t113 * mrSges(9,1) - t56 * t36 + t115 * t53;
t26 = -t56 * qJD(8) + t95 * t61 - t94 * t63;
t54 = t115 * mrSges(9,1) - t56 * mrSges(9,3);
t18 = m(9) * (t94 * t33 + t95 * t34) + t26 * mrSges(9,3) - t113 * mrSges(9,2) + t55 * t36 - t115 * t54;
t75 = -t90 * mrSges(8,1) + t92 * mrSges(8,2);
t84 = -t121 * mrSges(8,2) + t90 * mrSges(8,3);
t10 = m(8) * t156 + t119 * mrSges(8,1) - t63 * mrSges(8,3) + t121 * t84 + t95 * t17 + t94 * t18 - t92 * t75;
t101 = (-mrSges(3,1) * t138 + mrSges(3,2) * t130) * qJD(1);
t109 = -qJD(2) * mrSges(3,2) + mrSges(3,3) * t163;
t86 = t121 * mrSges(8,1) - t92 * mrSges(8,3);
t11 = m(8) * t167 - t119 * mrSges(8,2) + t61 * mrSges(8,3) - t121 * t86 - t94 * t17 + t95 * t18 + t90 * t75;
t114 = qJDD(4) + t120;
t116 = qJD(4) + t122;
t112 = t116 ^ 2;
...
t127 = sin(qJ(5));
t135 = cos(qJ(5));
t62 = -t93 * qJD(3) + t129 * t103 - t137 * t105;
t64 = t91 * qJD(3) - t137 * t103 - t129 * t105;
t71 = -t128 * t93 + t136 * t91;
t32 = t71 * qJD(4) + t128 * t62 + t136 * t64;
t72 = t128 * t91 + t136 * t93;
t58 = t127 * t116 + t135 * t72;
t22 = -t58 * qJD(5) + t135 * t114 - t127 * t32;
t57 = t135 * t116 - t127 * t72;
t23 = t57 * qJD(5) + t127 * t114 + t135 * t32;
t68 = qJD(5) - t71;
