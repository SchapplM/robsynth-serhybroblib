...
function T = palh3m1OL_energykin_floatb_twist_slag_vp1(qJ, qJD, V_base, ...
  pkin, m, rSges, Icges)
%% Coder Information
%#codegen
%$cgargs {zeros(10,1),zeros(10,1),zeros(6,1),zeros(16,1),zeros(9,1),zeros(9,3),zeros(9,6)}
assert(isreal(qJ) && all(size(qJ) == [10 1]), ...
  'palh3m1OL_energykin_floatb_twist_slag_vp1: qJ has to be [10x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [10 1]), ...
  'palh3m1OL_energykin_floatb_twist_slag_vp1: qJD has to be [10x1] (double)');
assert(isreal(V_base) && all(size(V_base) == [6 1]), ...
  'palh3m1OL_energykin_floatb_twist_slag_vp1: V_base has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [16 1]), ...
  'palh3m1OL_energykin_floatb_twist_slag_vp1: pkin has to be [16x1] (double)');
assert(isreal(m) && all(size(m) == [9 1]), ...
  'palh3m1OL_energykin_floatb_twist_slag_vp1: m has to be [9x1] (double)'); 
assert(isreal(rSges) && all(size(rSges) == [9,3]), ...
  'palh3m1OL_energykin_floatb_twist_slag_vp1: rSges has to be [9x3] (double)');
assert(isreal(Icges) && all(size(Icges) == [9 6]), ...
  'palh3m1OL_energykin_floatb_twist_slag_vp1: Icges has to be [9x6] (double)'); 

%% Symbolic Calculation
% From energy_kinetic_floatb_twist_worldframe_par1_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-20 17:03:45
% EndTime: 2020-04-20 17:03:52
...
t1 = (Icges(1,5) * V_base(4) + Icges(1,6) * V_base(5) + Icges(1,3) * V_base(6) / 0.2e1) * V_base(6) + ((t184 * t283 + t188 * t279) * t252 + (t183 * t283 + t187 * t279) * t250 + (t182 * t281 + t186 * t277) * t251 + (t181 * t281 + t185 * t277) * t249 + (-t164 * t269 - t168 * t267) * t225 + (-t163 * t269 - t167 * t267) * t223 + (t162 * t268 + t166 * t266) * t224 + (t161 * t268 + t165 * t266) * t222 + (-t150 * t259 - t152 * t258) * t205 + (-t149 * t259 - t151 * t258) * t203 + (-t134 * t254 + t136 * t253) * t204 + (-t133 * t254 + t135 * t253) * t202 + (-t194 * t254 + t195 * t253 - t207 * t259 - t208 * t258 + t215 * t268 - t216 * t269 + t217 * t266 - t218 * t267 + t236 * t281 + t237 * t283 + t240 * t277 + t241 * t279 + Icges(2,3)) * t261) * t261 / 0.2e1 + t141 * ((-t119 * t347 + t121 * t198 + t123 * t199) * t142 + (-t118 * t347 + t120 * t198 + t122 * t199) * t141 + (-t128 * t347 + t129 * t198 + t130 * t199) * t226) / 0.2e1 + t142 * ((-t119 * t346 + t200 * t121 + t201 * t123) * t142 + (-t118 * t346 + t200 * t120 + t201 * t122) * t141 + (-t128 * t346 + t200 * t129 + t201 * t130) * t226) / 0.2e1 + m(2) * (t140 ^ 2 + t145 ^ 2 + t146 ^ 2) / 0.2e1 + m(8) * (t106 ^ 2 + t108 ^ 2 + t110 ^ 2) / 0.2e1 + m(4) * (t107 ^ 2 + t109 ^ 2 + t111 ^ 2) / 0.2e1 + m(7) * (t113 ^ 2 + t114 ^ 2 + t115 ^ 2) / 0.2e1 + m(3) * (t112 ^ 2 + t116 ^ 2 + t117 ^ 2) / 0.2e1 + m(9) * (t100 ^ 2 + t102 ^ 2 + t103 ^ 2) / 0.2e1 + m(5) * (t101 ^ 2 + t104 ^ 2 + t105 ^ 2) / 0.2e1 + m(6) * (t97 ^ 2 + t98 ^ 2 + t99 ^ 2) / 0.2e1 + t226 * ((t118 * t141 + t119 * t142 + t128 * t226) * t259 + ((t121 * t278 - t123 * t282) * t142 + (t120 * t278 - t122 * t282) * t141 + (t129 * t278 - t130 * t282) * t226) * t258) / 0.2e1 + t261 * V_base(5) * (Icges(2,5) * t280 + Icges(2,6) * t284) + t261 * V_base(4) * (Icges(2,5) * t284 - Icges(2,6) * t280) + t225 * (t280 * t297 + t284 * t287) / 0.2e1 + t223 * (t280 * t287 - t284 * t297) / 0.2e1 + t224 * (t280 * t298 + t284 * t288) / 0.2e1 + t222 * (t280 * t288 - t284 * t298) / 0.2e1 + t205 * (t280 * t299 + t284 * t289) / 0.2e1 + t203 * (t280 * t289 - t284 * t299) / 0.2e1 + t204 * (t280 * t300 + t284 * t290) / 0.2e1 + t202 * (t280 * t290 - t284 * t300) / 0.2e1 + t252 * (t280 * t295 + t284 * t285) / 0.2e1 + t250 * (t280 * t285 - t284 * t295) / 0.2e1 + t251 * (t280 * t296 + t284 * t286) / 0.2e1 + t249 * (t280 * t286 - t284 * t296) / 0.2e1 + ((-t280 * t238 + t242 * t284 + Icges(1,4)) * V_base(5) + (-t280 * t239 + t243 * t284 + Icges(1,1)) * V_base(4)) * V_base(4) / 0.2e1 + ((t238 * t284 + t280 * t242 + Icges(1,2)) * V_base(5) + (t239 * t284 + t280 * t243 + Icges(1,4)) * V_base(4)) * V_base(5) / 0.2e1 + m(1) * (t229 ^ 2 + t230 ^ 2 + t231 ^ 2) / 0.2e1;
T = t1;
