...
function [v_mdh, sigma_mdh, mu_mdh, NL, NKP, NQJ, pkin_names] = palh3m1OL_structural_kinematic_parameters()
...
pkin_names = {'AB', 'BC', 'BE', 'BG', 'DC', 'DT2', 'EP', 'GH', 'GP', 'HW', 'OT1', 'T1A', 'T1T2', 'phi410', 'phi78', 'phi79'};
