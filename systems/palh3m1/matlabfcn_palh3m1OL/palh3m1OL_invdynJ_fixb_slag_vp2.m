...
function tau = palh3m1OL_invdynJ_fixb_slag_vp2(qJ, qJD, qJDD, g, ...
  pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(10,1),zeros(10,1),zeros(10,1),zeros(3,1),zeros(16,1),zeros(9,1),zeros(9,3),zeros(9,6)}
assert(isreal(qJ) && all(size(qJ) == [10 1]), ...
  'palh3m1OL_invdynJ_fixb_slag_vp2: qJ has to be [10x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [10 1]), ...
  'palh3m1OL_invdynJ_fixb_slag_vp2: qJD has to be [10x1] (double)');
assert(isreal(qJDD) && all(size(qJDD) == [10 1]), ...
  'palh3m1OL_invdynJ_fixb_slag_vp2: qJDD has to be [10x1] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'palh3m1OL_invdynJ_fixb_slag_vp2: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [16 1]), ...
  'palh3m1OL_invdynJ_fixb_slag_vp2: pkin has to be [16x1] (double)');
assert(isreal(m) && all(size(m) == [9 1]), ...
  'palh3m1OL_invdynJ_fixb_slag_vp2: m has to be [9x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [9,3]), ...
  'palh3m1OL_invdynJ_fixb_slag_vp2: mrSges has to be [9x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [9 6]), ...
  'palh3m1OL_invdynJ_fixb_slag_vp2: Ifges has to be [9x6] (double)'); 

%% Symbolic Calculation
% From invdyn_fixb_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2020-04-20 17:03:59
% EndTime: 2020-04-20 17:06:16
% DurationCPUTime: 27.07s
...
t76 = -t519 + t91;
t341 = -t421 + (-pkin(10) * m(6) - mrSges(6,3)) * t287;
...
t333 = t261 * (-mrSges(4,1) * t222 + mrSges(4,2) * t220) + t222 * t398 + t222 * (Ifges(4,1) * t220 + t477) / 0.2e1 - t220 * t397 - t314 * (Ifges(4,5) * t220 + Ifges(4,6) * t222) / 0.2e1 + Ifges(4,3) * t312 - t232 * mrSges(4,2) + t231 * mrSges(4,1) + Ifges(4,5) * t134 + Ifges(4,6) * t135 + t147 * t535 - (Ifges(4,2) * t222 + t149 + t207) * t220 / 0.2e1 + t595;
t295 = Ifges(3,4) * t442;
t290 = -pkin(8) - t515;
t263 = t520 + t524;
t262 = t521 + t527;
...
t1 = [(mrSges(8,2) * t203 - mrSges(8,3) * t229 + Ifges(8,1) * t132 + Ifges(8,4) * t133 + Ifges(8,5) * t311) * t239 + (-mrSges(4,1) * t203 + mrSges(4,3) * t232 + Ifges(4,4) * t134 + Ifges(4,2) * t135 + Ifges(4,6) * t312) * t238 + (m(3) * pkin(12) ^ 2 + pkin(6) * t350 + Ifges(2,3)) * qJDD(1) + (t97 * mrSges(5,2) - t100 * mrSges(5,3) + Ifges(5,1) * t49 + Ifges(5,4) * t50 + Ifges(5,5) * t301 + t380 * t549 + t383 * t551 + t385 * t552 + t389 * t94 + t410 * t45) * t171 + t558 * (pkin(8) * t75 - pkin(10) * t74 + t158) + (-mrSges(8,1) * t203 + mrSges(8,3) * t230 + Ifges(8,4) * t132 + Ifges(8,2) * t133 + Ifges(8,6) * t311) * t237 + (t358 + t327 * (-Ifges(7,2) * t320 + t486)) * t433 / 0.2e1 + t400 * (Ifges(9,4) * t41 + Ifges(9,2) * t42) / 0.2e1 + t399 * (Ifges(5,4) * t74 - Ifges(5,2) * t75) / 0.2e1 + (m(9) * t61 - mrSges(9,1) * t28 + mrSges(9,2) * t27) * ((-t237 * t318 - t239 * t317) * pkin(3) - t285) + (t77 * t436 + m(6) * (qJD(5) * t377 + t2 * t321 + t3 * t328) - t78 * t437 + t321 * t10 + t328 * t9) * (-pkin(8) * t373 - pkin(10) * t171 + t193) - (t430 / 0.2e1 - t99 * mrSges(5,3) - Ifges(5,4) * t49 - Ifges(5,2) * t50 - Ifges(5,6) * t301 + t97 * mrSges(5,1) + Ifges(6,3) * t549 + Ifges(6,6) * t551 + Ifges(6,5) * t552 + t559) * t373 + (-mrSges(9,1) * t61 + mrSges(9,3) * t54 + Ifges(9,4) * t27 + Ifges(9,2) * t28 + Ifges(9,6) * t300) * (-t234 * t237 + t239 * t343) + (mrSges(9,2) * t61 - mrSges(9,3) * t55 + Ifges(9,1) * t27 + Ifges(9,4) * t28 + Ifges(9,5) * t300) * (-t234 * t239 - t237 * t343) - (mrSges(4,2) * t203 - mrSges(4,3) * t231 + Ifges(4,1) * t134 + Ifges(4,4) * t135 + Ifges(4,5) * t312) * t371 + t246 * t490 / 0.2e1 + (-t2 * t464 - t3 * t463 + t364 * t51 - t365 * t52) * mrSges(6,3) + t575 * t297 + (m(5) * t97 - mrSges(5,1) * t50 + mrSges(5,2) * t49) * t193 + (t200 * mrSges(6,1) - t199 * mrSges(6,2) + t325 * t556 + t332 * t554) * g(2) + (-t198 * mrSges(6,1) + t197 * mrSges(6,2) - t325 * t554 + t332 * t556) * g(1) + (0.2e1 * Ifges(7,5) * t532 + Ifges(7,6) * t327) * qJDD(6) + (Ifges(3,1) * t246 + Ifges(3,4) * t583 + Ifges(3,5) * qJDD(2) - t406 * t580) * t324 + t578 * t158 + t579 * (t297 + (-t172 * t317 - t173 * t318) * pkin(3)) - t75 * t581 - t74 * t480 + (t450 / 0.2e1 + t379 * qJD(6) / 0.2e1) * qJD(6) + t75 * t479 - t42 * t483 + (t490 * t406 + t566 / 0.2e1) * t331 + (Ifges(3,4) * t246 + Ifges(3,2) * t245 + t566) * t530 - t365 * t44 / 0.2e1 + (t218 * t530 + t381 * qJD(2) / 0.2e1) * qJD(2) - t172 * t395 + t456 * t506 + t363 * t433 + (Ifges(7,1) * t244 + Ifges(7,4) * t243) * t532 + t7 * t463 / 0.2e1 - t6 * t464 / 0.2e1 - t41 * t484 - t216 * t441 / 0.2e1 + t244 * (t474 + t486) / 0.2e1 + t174 * t397 + t173 * t396 - (-mrSges(4,1) * t175 - mrSges(8,1) * t173 + mrSges(4,2) * t174 + mrSges(8,2) * t172) * t261 + t74 * t415 + t357 * t406 + t314 * (Ifges(4,5) * t174 + Ifges(4,6) * t175) / 0.2e1 + t313 * (Ifges(8,5) * t172 + Ifges(8,6) * t173) / 0.2e1 + t302 * (Ifges(9,5) * t41 + Ifges(9,6) * t42) / 0.2e1 + t303 * (Ifges(5,5) * t74 - Ifges(5,6) * t75) / 0.2e1 + t327 * (Ifges(7,4) * t244 + Ifges(7,2) * t243) / 0.2e1 - pkin(12) * (-mrSges(3,1) * t245 + mrSges(3,2) * t246) + pkin(6) * (-mrSges(7,1) * t243 + mrSges(7,2) * t244) + t219 * (Ifges(8,4) * t172 + Ifges(8,2) * t173) / 0.2e1 + t220 * (Ifges(4,4) * t174 + Ifges(4,2) * t175) / 0.2e1 + t180 * (mrSges(5,1) * t75 + mrSges(5,2) * t74) + t174 * t149 / 0.2e1 + t175 * t147 / 0.2e1 + t172 * t148 / 0.2e1 + t173 * t146 / 0.2e1 + t243 * t382 / 0.2e1 + t131 * (-mrSges(9,1) * t42 + mrSges(9,2) * t41) + t109 * (Ifges(9,1) * t41 + Ifges(9,4) * t42) / 0.2e1 + t176 * (mrSges(6,1) * t365 - mrSges(6,2) * t364) + t153 * (-Ifges(6,5) * t364 - Ifges(6,6) * t365 + Ifges(6,3) * t75) / 0.2e1 + t125 * (-Ifges(6,4) * t364 - Ifges(6,2) * t365 + Ifges(6,6) * t75) / 0.2e1 - t75 * t83 / 0.2e1 + t74 * t84 / 0.2e1 + t75 * t43 / 0.2e1 + t42 * t57 / 0.2e1 + t41 * t58 / 0.2e1 - t362 * t434 - t260 * t435 - t175 * t398 + t594 * (-t203 * t285 - t261 * t297) + (mrSges(4,1) * t135 + mrSges(8,1) * t133 - mrSges(4,2) * t134 - mrSges(8,2) * t132) * t285 + (Ifges(4,1) * t174 + Ifges(4,4) * t175) * t535 + (Ifges(8,1) * t172 + Ifges(8,4) * t173) * t536 + (Ifges(5,1) * t74 - Ifges(5,4) * t75) * t539 + (-Ifges(6,1) * t364 - Ifges(6,4) * t365 + Ifges(6,5) * t75) * t543 + t75 * t582 + t384 * t583; (-m(5) * t370 + m(6) * t377 + t562) * (t291 * t438 + (t323 * t439 + (-t329 * t330 + t454) * qJD(3)) * pkin(1)) + (t325 * t561 - t247 + t563) * g(2) + (t332 * t561 - t248 + t564) * g(1) + (-t185 * t440 + m(8) * (t229 * t326 + t230 * t319) + m(4) * (-t231 * t330 - t232 * t323)) * pkin(1) + (m(5) * t181 - t560) * (-t291 * t439 + (qJD(3) * t372 + t323 * t438) * pkin(1)) - (-Ifges(3,2) * t443 + t218 + t295) * t442 / 0.2e1 + (t362 - t357 / 0.2e1) * qJD(1) ^ 2 + m(9) * (t114 * t80 - t115 * t79 + t138 * t55 + t139 * t54) - t558 * t76 + t578 * t519 - t579 * t150 + t555 * (pkin(10) + t210) + t216 * t443 / 0.2e1 + (-t186 * t319 + t462) * t504 - (mrSges(4,1) * t312 - mrSges(4,3) * t134) * t523 - (-mrSges(4,2) * t312 + mrSges(4,3) * t135) * t526 + t565 * (-pkin(8) - t209) + (-m(5) * t409 - m(9) * t444 + (-m(6) - t594) * t310 + t557 + t598) * g(3) + (t261 * t594 - t558 - t575 - t578 - t579) * pkin(1) * t443 + t221 * t396 + (m(8) * t525 - t387 + t390) * t567 + Ifges(3,5) * t246 + Ifges(3,6) * t245 + t209 * t36 + t210 * t37 + Ifges(3,3) * qJDD(2) + t138 * t19 + t139 * t20 + t79 * t95 + t80 * t96 - t381 * t434 / 0.2e1 + (mrSges(8,1) * t311 - mrSges(8,3) * t132) * t524 + (-mrSges(8,2) * t311 + mrSges(8,3) * t133) * t527 + t333 + t334 + t187 * t425 + m(5) * (t100 * t209 + t210 * t99); -t205 * t136 + t185 * t426 - t187 * t428 + t290 * t8 + t36 * t515 + t37 * t516 + t90 * t519 - t64 * t78 - t65 * t77 + t333 + (t290 * t94 + (t176 * t322 + t329 * t377) * qJD(4) * pkin(4) + t176 * t204 - t51 * t64 - t52 * t65) * m(6) + (t180 * t519 - t181 * t204 + t370 * t205 + (t100 * t329 + t322 * t99 + (-t181 * t322 - t329 * t370) * qJD(4)) * pkin(4)) * m(5) + t562 * pkin(4) * t438 + (m(5) * t517 + t557) * g(3) + (t325 * t574 + t563) * g(2) + (t332 * t574 + t564) * g(1) + t555 * (pkin(10) + t516) + t593 * (-pkin(4) * t439 - t204); -m(6) * (t51 * t69 + t52 * t70) - t181 * t136 - t70 * t77 - t69 * t78 + t560 * t370 + (m(6) * t392 + t573) * g(3) + (-t325 * t341 + t570) * g(2) + (-t332 * t341 + t571) * g(1) - t565 * pkin(8) + t555 * pkin(10) + t595; -t176 * (mrSges(6,1) * t126 + mrSges(6,2) * t125) + (Ifges(6,5) * t125 - Ifges(6,6) * t126) * t542 + t52 * t78 - t51 * t77 + t44 * t543 + (Ifges(6,1) * t125 - t482) * t544 - g(1) * (mrSges(6,1) * t199 + mrSges(6,2) * t200) - g(2) * (mrSges(6,1) * t197 + mrSges(6,2) * t198) - g(3) * t389 * t286 + (t125 * t51 + t126 * t52) * mrSges(6,3) + t430 + (-Ifges(6,2) * t126 + t124 + t45) * t545 + t559; Ifges(7,5) * t244 + Ifges(7,6) * t243 + Ifges(7,3) * qJDD(6) + g(3) * t259 + (-t450 / 0.2e1 + t456 / 0.2e1 - t327 * t294 / 0.2e1 + t379 * t506 + (-t358 / 0.2e1 - t363 + t470 * t532) * qJD(1)) * qJD(1) + t567 * t388; t577 * t96 + t576 * t95 + t572 * g(3) + (-t462 + (t186 + t492) * t319) * t505 + t163 * t19 + t164 * t20 - t150 * t63 - g(2) * t247 - g(1) * t248 + t334 + t567 * (-m(9) * t522 - t387 + t500) + (-t273 * g(3) + t114 * t577 - t115 * t576 - t131 * t150 + t163 * t55 + t164 * t54) * m(9); -t115 * t96 + g(3) * t386 - g(2) * (-t325 * t500 + t247) - g(1) * (-t332 * t500 + t248) + (-t95 + t485) * t114 + t589 * t400 + t587; 0; 0;];
tau = t1;
