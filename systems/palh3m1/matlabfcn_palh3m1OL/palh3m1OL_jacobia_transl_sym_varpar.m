...
function Ja_transl = palh3m1OL_jacobia_transl_sym_varpar(qJ, link_index, r_i_i_C, ...
  pkin)
...
assert(isreal(qJ) && all(size(qJ) == [10 1]), ...
  'palh3m1OL_jacobia_transl_sym_varpar: qJ has to be [10x1] (double)');
assert(isa(r_i_i_C,'double') && isreal(r_i_i_C) && all(size(r_i_i_C) == [3 1]), ...
	'palh3m1OL_jacobia_transl_sym_varpar: Position vector r_i_i_C has to be [3x1] double');
assert(isa(link_index,'uint8') && all(size(link_index) == [1 1]), ...
	'palh3m1OL_jacobia_transl_sym_varpar: link_index has to be [1x1] uint8');
assert(isreal(pkin) && all(size(pkin) == [16 1]), ...
  'palh3m1OL_jacobia_transl_sym_varpar: pkin has to be [16x1] (double)');
Ja_transl=NaN(3,10);
if link_index == 0
...
elseif link_index == 3
	...
	t16 = sin(qJ(2)) * pkin(1);
	t14 = -pkin(12) - t22;
	t1 = [t13 * r_i_i_C(3) + t14 * t12, -t13 * t16 + t17, t17, 0, 0, 0, 0, 0, 0, 0; t12 * r_i_i_C(3) - t14 * t13, -t12 * t16 + t18, t18, 0, 0, 0, 0, 0, 0, 0; 0, t22, t15, 0, 0, 0, 0, 0, 0, 0;];
	Ja_transl = t1;
elseif link_index == 4
	%% Symbolic Calculation
